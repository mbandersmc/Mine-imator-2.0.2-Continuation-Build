...
namespace CppProject
{
	IntType list_init_context_menu(ScopeAny self, VarType name)
	{
		...
		if (sStr(context_menu_value_name) != /*""*/ STR(0))
		{
			...
			{
				case 1473: // pathoffset
				{
					list_item_add({ text_get({ /*"contextmenupathsetlength"*/ STR(1474) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_tl_frame_path_offset_set_length });
					break;
				}
		...
		{
			case 1039: // contextmenuvalue
			case 1475: // contextmenucategory
			{
				if (sInt(context_menu_group) == e_context_group_SCALE && sReal(setting_advanced_mode) > 0)
				{
					StringType text = ((ObjType(obj_category, ObjType(obj_tab, sInt(frame_editor))->transform)->scale_all > 0) ? /*"contextmenuscaleseparate"*/ STR(1476) : /*"contextmenuscalecombine"*/ STR(1477));
					list_item_add({ text_get({ text }), null_, /*""*/ STR(0), null_, icons_SCALE, null_, ID_action_group_combine_scale, true });
				}
				if (name == /*"contextmenuvalue"*/ STR(1039))
				{
					list_item_add({ text_get({ /*"contextmenuvaluecut"*/ STR(1478) }), null_, /*""*/ STR(0), null_, icons_CUT, null_, ID_action_value_cut, true });
					list_item_add({ text_get({ /*"contextmenuvaluecopy"*/ STR(1479) }), null_, /*""*/ STR(0), null_, icons_COPY, null_, ID_action_value_copy, false });
					...
					list_item_add({ text_get({ /*"contextmenuvaluepaste"*/ STR(1480) }), null_, caption, null_, icons_PASTE, null_, ID_action_value_paste, false });
					...
					list_item_add({ text_get({ /*"contextmenuvaluereset"*/ STR(1481) }), null_, /*""*/ STR(0), null_, icons_RESET, null_, ID_action_value_reset, false });
				}
				if (sInt(context_menu_group) != null_)
				{
					list_item_add({ text_get({ /*"contextmenugroupcopy"*/ STR(1482) }), null_, /*""*/ STR(0), null_, icons_COPY_ALL, null_, ID_action_group_copy, true });
					list_item_add({ text_get({ /*"contextmenugrouppaste"*/ STR(1483) }), null_, /*""*/ STR(0), null_, icons_PASTE_ALL, null_, ID_action_group_paste, false });
					...
					list_item_add({ text_get({ /*"contextmenugroupreset"*/ STR(1484) }), null_, /*""*/ STR(0), null_, icons_RESET_ALL, null_, ID_action_group_reset, false });
					if (sInt(context_menu_group) == e_context_group_POSITION)
						list_item_add({ text_get({ /*"contextmenugroupcopyglobalposition"*/ STR(1485) }), null_, /*""*/ STR(0), null_, icons_COPY_ALL, null_, ID_action_group_copy_global, true });
				}
				break;
			}
			
			case 1050: // contextmenutextbox
			{
				list_item_add({ text_get({ /*"contextmenutextboxcut"*/ STR(1486) }), null_, text_control_name(keybind_new({ /*"X"*/ STR(266), true })), null_, icons_CUT, null_, ID_action_textbox_cut, true });
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(textbox_select_startpos) == sVar(textbox_select_endpos));
				list_item_add({ text_get({ /*"contextmenutextboxcopy"*/ STR(1487) }), null_, text_control_name(keybind_new({ /*"C"*/ STR(264), true })), null_, icons_COPY, null_, ID_action_textbox_copy, false });
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(textbox_select_startpos) == sVar(textbox_select_endpos));
				list_item_add({ text_get({ /*"contextmenutextboxpaste"*/ STR(1488) }), null_, text_control_name(keybind_new({ /*"V"*/ STR(268), true })), null_, icons_PASTE, null_, ID_action_textbox_paste, false });
				ObjType(obj_list_item, global::list_item_last)->disabled = (clipboard_get_text() == /*""*/ STR(0) || !clipboard_has_text());
				list_item_add({ text_get({ /*"contextmenutextboxselectall"*/ STR(1489) }), null_, text_control_name(keybind_new({ /*"A"*/ STR(255), true })), null_, icons_SELECT_ALL, null_, ID_action_textbox_select_all, false });
				break;
			}
			
			case 1490: // timelinelist
			{
				list_item_add({ text_get({ /*"contextmenutladdfolder"*/ STR(1491) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_CREATE_FOLDER))->keybind), null_, icons_FOLDER, null_, ID_action_tl_folder, true });
				list_item_add({ text_get({ /*"contextmenutlselectkeyframes"*/ STR(1492) }), sVar(context_menu_value), /*""*/ STR(0), null_, icons_KEYFRAME, null_, ID_action_tl_select_keyframes });
				...
				{
					list_item_add({ text_get({ /*"contextmenutlcolortag"*/ STR(1493) }), null_, /*""*/ STR(0), null_, icons_TAG, icons_CHEVRON_RIGHT_TINY, null_ });
					ObjType(obj_list_item, global::list_item_last)->context_menu_name = /*"color"*/ STR(888);
					ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(context_menu_value) == null_ && global::tl_edit == null_);
				}
				list_item_add({ text_get({ /*"contextmenutlexpandchildren"*/ STR(1494) }), null_, /*""*/ STR(0), null_, icons_MAXIMIZE, null_, ID_action_tl_extend_children });
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(context_menu_value) == null_ && global::tl_edit == null_);
				list_item_add({ text_get({ /*"contextmenutlcollapsechildren"*/ STR(1495) }), null_, /*""*/ STR(0), null_, icons_MINIMIZE, null_, ID_action_tl_collapse_children });
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(context_menu_value) == null_ && global::tl_edit == null_);
				list_item_add({ text_get({ /*"contextmenutlduplicate"*/ STR(1496) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_DUPLICATE))->keybind), null_, icons_DUPLICATE, null_, ID_action_tl_duplicate, true });
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(context_menu_value) == null_ && global::tl_edit == null_);
				list_item_add({ text_get({ /*"contextmenutldelete"*/ STR(1497) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_DELETE))->keybind), null_, icons_DELETE, null_, ID_action_tl_remove });
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(context_menu_value) == null_ && global::tl_edit == null_);
				list_item_add({ text_get({ /*"contextmenutlexport"*/ STR(1498) }), null_, /*""*/ STR(0), null_, icons_ASSET_EXPORT, null_, ID_object_save });
				...
				list_item_add({ text_get({ /*"contextmenutlselectall"*/ STR(1499) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_SELECT))->keybind), null_, icons_SELECT_ALL, null_, ID_action_tl_select_all, true });
				list_item_add({ text_get({ /*"contextmenutlexpandall"*/ STR(1500) }), null_, /*""*/ STR(0), null_, icons_MAXIMIZE, null_, ID_action_tl_extend_all });
				list_item_add({ text_get({ /*"contextmenutlcollapseall"*/ STR(1501) }), null_, /*""*/ STR(0), null_, icons_MINIMIZE, null_, ID_action_tl_collapse_all });
				break;
			}
			
			case 119: // timeline
			{
				list_item_add({ text_get({ /*"contextmenutlkeyframestransition"*/ STR(1502) }), null_, /*""*/ STR(0), null_, icons_EASE_IN_OUT, icons_CHEVRON_RIGHT_TINY, null_, true });
				...
				ObjType(obj_list_item, global::list_item_last)->context_menu_name = /*"timelinelkeyframetransitions"*/ STR(1503);
				list_item_add({ text_get({ /*"contextmenutlkeyframescut"*/ STR(1504) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_KEYFRAMES_CUT))->keybind), null_, icons_CUT_KEYFRAME, null_, ID_action_tl_keyframes_cut, true });
				ObjType(obj_list_item, global::list_item_last)->disabled = !sBool(timeline_settings_keyframes);
				list_item_add({ text_get({ /*"contextmenutlkeyframescopy"*/ STR(1505) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_KEYFRAMES_COPY))->keybind), null_, icons_COPY_KEYFRAME, null_, ID_tl_keyframes_copy });
				ObjType(obj_list_item, global::list_item_last)->disabled = !sBool(timeline_settings_keyframes);
				list_item_add({ text_get({ /*"contextmenutlkeyframespaste"*/ STR(1506) }), sVar(timeline_insert_pos), text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_KEYFRAMES_PASTE))->keybind), null_, icons_PASTE_KEYFRAME, null_, ID_action_tl_keyframes_paste });
				ObjType(obj_list_item, global::list_item_last)->disabled = (sInt(copy_kf_amount) == IntType(0));
				list_item_add({ text_get({ /*"contextmenutlkeyframesdelete"*/ STR(1507) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_KEYFRAMES_DELETE))->keybind), null_, icons_DELETE_KEYFRAME, null_, ID_action_tl_keyframes_remove });
				ObjType(obj_list_item, global::list_item_last)->disabled = !sBool(timeline_settings_keyframes);
				list_item_add({ text_get({ /*"contextmenutlkeyframesexport"*/ STR(1508) }), null_, /*""*/ STR(0), null_, icons_SAVE_KEYFRAME, null_, ID_keyframes_save });
				ObjType(obj_list_item, global::list_item_last)->disabled = !sBool(timeline_settings_keyframes_export);
				list_item_add({ text_get({ /*"contextmenutlkeyframesselect"*/ STR(1509) }), null_, /*""*/ STR(0), null_, icons_SELECT_ALL_KEYFRAME, icons_CHEVRON_RIGHT_TINY, null_ });
				ObjType(obj_list_item, global::list_item_last)->context_menu_name = /*"timelinelkeyframesselect"*/ STR(1510);
				list_item_add({ text_get({ /*"contextmenutlkeyframeswalk"*/ STR(1511) }), sStr(timeline_settings_walk_fn), /*""*/ STR(0), null_, icons_WALK_CYCLE, null_, ID_action_tl_load_loop, true });
				ObjType(obj_list_item, global::list_item_last)->disabled = !file_exists_lib(sStr(timeline_settings_walk_fn));
				list_item_add({ text_get({ /*"contextmenutlkeyframesrun"*/ STR(1512) }), sStr(timeline_settings_run_fn), /*""*/ STR(0), null_, icons_RUN_CYCLE, null_, ID_action_tl_load_loop });
				ObjType(obj_list_item, global::list_item_last)->disabled = !file_exists_lib(sStr(timeline_settings_run_fn));
				list_item_add({ text_get({ /*"contextmenutlmarkeradd"*/ STR(1513) }), null_, /*""*/ STR(0), null_, icons_MARKER_ADD, null_, ID_action_tl_marker_new, true });
			...
			case 1510: // timelinelkeyframesselect
			{
				list_item_add({ text_get({ /*"contextmenutlkeyframesselectbefore"*/ STR(1514) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_tl_select_keyframes_before_marker });
				list_item_add({ text_get({ /*"contextmenutlkeyframesselectafter"*/ STR(1515) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_tl_select_keyframes_after_marker });
				list_item_add({ text_get({ /*"contextmenutlkeyframesselectfirst"*/ STR(1516) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_tl_select_keyframes_first });
				list_item_add({ text_get({ /*"contextmenutlkeyframesselectlast"*/ STR(1517) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_tl_select_keyframes_last });
				list_item_add({ text_get({ /*"contextmenutlkeyframesselectregion"*/ STR(1518) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_tl_select_keyframes_region });
				ObjType(obj_list_item, global::list_item_last)->disabled = (sVar(timeline_region_start) == null_);
				break;
			}
			
			case 1519: // timelinemarker
			{
				list_item_add({ text_get({ /*"contextmenutlmarkeredit"*/ STR(1520) }), sVar(context_menu_value), /*""*/ STR(0), null_, icons_PENCIL, null_, ID_action_tl_marker_editor, true });
				list_item_add({ text_get({ /*"contextmenutlmarkerdelete"*/ STR(1521) }), null_, /*""*/ STR(0), null_, icons_DELETE, null_, ID_action_tl_marker_delete });
				break;
			}
			
			case 888: // color
			{
				list_item_add({ text_get({ /*"contextmenucolornone"*/ STR(1522) }), null_, /*""*/ STR(0), null_, icons_CLOSE, null_, ID_action_tl_color_tag_remove, true });
				for (IntType i = IntType(0); i <= IntType(8); i++)
				{
					list_item_add({ text_get({ /*"contextmenucolor"*/ STR(1523) + string(i) }), i, /*""*/ STR(0), ID_spr_16, null_, null_, ID_action_tl_color_tag });
					ObjType(obj_list_item, global::list_item_last)->thumbnail_blend = ObjType(obj_theme, sInt(setting_theme))->accent_list.Value(i);
				}
				break;
			}
			
			case 1524: // toolbarfile
			{
				list_item_add({ text_get({ /*"toolbarfilenew"*/ STR(1525) }), VarType(), text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_PROJECT_NEW))->keybind), null_, icons_FILE, null_, ID_action_toolbar_new });
				list_item_add({ text_get({ /*"toolbarfileopen"*/ STR(1526) }), VarType(), text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_PROJECT_OPEN))->keybind), null_, icons_FOLDER, null_, ID_action_toolbar_open });
				list_item_add({ text_get({ /*"toolbarfilerecent"*/ STR(1527) }), VarType(), /*""*/ STR(0), null_, icons_FOLDER_RECENTS, icons_CHEVRON_RIGHT_TINY, null_ });
				ObjType(obj_list_item, global::list_item_last)->context_menu_name = /*"toolbarfilerecent"*/ STR(1527);
				list_item_add({ text_get({ /*"toolbarfilelastbackup"*/ STR(1528) }), VarType(), /*""*/ STR(0), null_, icons_RECENTS, null_, ID_action_toolbar_open_last_backup });
				ObjType(obj_list_item, global::list_item_last)->disabled = !file_exists(sStr(project_folder) + /*"/"*/ STR(16) + filename_name(sStr(project_folder)) + /*".backup1"*/ STR(74));
				list_item_add({ text_get({ /*"toolbarfilesave"*/ STR(1529) }), VarType(), text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_PROJECT_SAVE))->keybind), null_, icons_SAVE, null_, ID_action_toolbar_save, true });
				list_item_add({ text_get({ /*"toolbarfilesaveas"*/ STR(1530) }), VarType(), text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_PROJECT_SAVE_AS))->keybind), null_, icons_SAVE_AS, null_, ID_action_toolbar_save_as });
				if (sStr(window_state) == /*""*/ STR(0))
				{
					list_item_add({ text_get({ /*"toolbarfileimport"*/ STR(1531) }), VarType(), text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_IMPORT_ASSET))->keybind), null_, icons_ASSET_IMPORT, null_, ID_action_toolbar_import_asset, true });
					list_item_add({ text_get({ /*"toolbarfileworldimport"*/ STR(1532) }), VarType(), /*""*/ STR(0), null_, icons_SCENERY, null_, ID_world_import_begin, false });
				}
				break;
			}
			
			case 1527: // toolbarfilerecent
			{
				VarType recent;
			...
			case 1533: // toolbaredit
			{
				list_item_add({ text_get({ /*"toolbareditundo"*/ STR(1534) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_UNDO))->keybind), null_, icons_UNDO, null_, ID_action_toolbar_undo });
				ObjType(obj_list_item, global::list_item_last)->disabled = (sReal(history_pos) == sReal(history_amount));
				list_item_add({ text_get({ /*"toolbareditredo"*/ STR(1535) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_REDO))->keybind), null_, icons_REDO, null_, ID_action_toolbar_redo });
				ObjType(obj_list_item, global::list_item_last)->disabled = (sReal(history_pos) == IntType(0));
				list_item_add({ text_get({ /*"toolbareditselectall"*/ STR(1536) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_SELECT))->keybind), null_, icons_SELECT_ALL, null_, ID_action_tl_select_all, true });
				ObjType(obj_list_item, global::list_item_last)->disabled = (ds_list_size(sInt(tree_list)) == IntType(0));
				list_item_add({ text_get({ /*"toolbareditduplicate"*/ STR(1537) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_DUPLICATE))->keybind), null_, icons_DUPLICATE, null_, ID_action_tl_duplicate, true });
				ObjType(obj_list_item, global::list_item_last)->disabled = (global::tl_edit == null_);
				list_item_add({ text_get({ /*"toolbareditdelete"*/ STR(1538) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_DELETE))->keybind), null_, icons_DELETE, null_, ID_action_tl_remove });
				ObjType(obj_list_item, global::list_item_last)->disabled = (global::tl_edit == null_);
				list_item_add({ text_get({ /*"toolbaredithide"*/ STR(1539) }), true, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_HIDE))->keybind), null_, icons_HIDDEN, null_, ID_action_tl_hide_select, true });
				ObjType(obj_list_item, global::list_item_last)->disabled = (global::tl_edit == null_);
				list_item_add({ text_get({ /*"toolbareditshowhidden"*/ STR(1540) }), false, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_TIMELINE_SHOW_HIDDEN))->keybind), null_, icons_VISIBLE, null_, ID_action_tl_hide_select });
				ObjType(obj_list_item, global::list_item_last)->disabled = (global::tl_edit == null_);
				list_item_add({ text_get({ /*"toolbareditpreferences"*/ STR(1541) }), sInt(settings), /*""*/ STR(0), null_, icons_SETTINGS, null_, (ObjType(obj_tab, sInt(settings))->show > 0) ? ID_tab_close : ID_tab_show, true });
				ObjType(obj_list_item, global::list_item_last)->toggled = ObjType(obj_tab, sInt(settings))->show;
				break;
			}
			
			case 1542: // toolbarrender
			{
				list_item_add({ text_get({ /*"toolbarrenderimage"*/ STR(1543) }), null_, /*""*/ STR(0), null_, icons_IMAGE_EXPORT, null_, ID_action_toolbar_export_image });
				list_item_add({ text_get({ /*"toolbarrenderanimation"*/ STR(1544) }), null_, /*""*/ STR(0), null_, icons_MOVIE_EXPORT, null_, ID_action_toolbar_export_movie });
				break;
			}
			
			case 1545: // toolbarview
			{
				if (sStr(window_state) == /*""*/ STR(0))
				{
					list_item_add({ text_get({ /*"toolbarviewreset"*/ STR(1546) }), null_, /*""*/ STR(0), null_, icons_CAMERA, null_, ID_camera_work_reset });
					list_item_add({ text_get({ /*"toolbarviewsecondaryview"*/ STR(1547) }), null_, text_control_name(ObjType(obj_keybind, global::keybinds.Value(e_keybind_SECONDARY_VIEW))->keybind), null_, icons_VIEWPORT_SECONDARY, null_, ID_action_setting_secondary_view });
					ObjType(obj_list_item, global::list_item_last)->toggled = ObjType(obj_view, sInt(view_second))->show;
					list_item_add({ text_get({ /*"toolbarviewtimelineshowmarkers"*/ STR(1548) }), null_, /*""*/ STR(0), null_, icons_MARKER, null_, ID_action_setting_timeline_show_markers });
					...
					list_item_add({ text_get({ /*"toolbarviewtimelineplayback"*/ STR(1549) }), null_, /*""*/ STR(0), null_, icons_CLOCK, icons_CHEVRON_RIGHT_TINY, null_ });
					ObjType(obj_list_item, global::list_item_last)->context_menu_name = /*"toolbarviewtimelineplayback"*/ STR(1549);
				}
				list_item_add({ text_get({ /*"toolbarviewshortcutsbar"*/ STR(1550) }), null_, /*""*/ STR(0), null_, icons_KEYBOARD, null_, ID_action_setting_shortcuts_bar, true });
				ObjType(obj_list_item, global::list_item_last)->toggled = sBool(setting_show_shortcuts_bar);
				list_item_add({ text_get({ /*"toolbarviewhome"*/ STR(1551) }), null_, /*""*/ STR(0), null_, icons_HOME, null_, ID_action_setting_home_screen, true });
				break;
			}
			
			case 1549: // toolbarviewtimelineplayback
			{
				list_item_add({ text_get({ /*"toolbarviewtimelineplaybacktimeseconds"*/ STR(1552) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_setting_timeline_display_time });
				ObjType(obj_list_item, global::list_item_last)->toggled = !(sReal(timeline_show_frames) > 0);
				ObjType(obj_list_item, global::list_item_last)->divider = true;
				list_item_add({ text_get({ /*"toolbarviewtimelineplaybacktimeframes"*/ STR(1553) }), null_, /*""*/ STR(0), null_, null_, null_, ID_action_setting_timeline_display_frames });
				ObjType(obj_list_item, global::list_item_last)->toggled = sReal(timeline_show_frames);
				break;
			}
			
			case 1554: // toolbarhelp
			{
				list_item_add({ text_get({ /*"toolbarhelpabout"*/ STR(1555) }), sInt(popup_about), /*""*/ STR(0), null_, icons_INFO, null_, ID_popup_show });
				if (global::trial_version > 0)
					list_item_add({ text_get({ /*"toolbarhelpupgrade"*/ STR(1556) }), sInt(popup_upgrade), /*""*/ STR(0), null_, icons_KEY, null_, ID_popup_show });
				list_item_add({ text_get({ /*"toolbarhelptutorials"*/ STR(1557) }), link_tutorials, /*""*/ STR(0), null_, icons_TUTORIALS, null_, ID_popup_open_url });
				list_item_add({ text_get({ /*"toolbarhelpreport"*/ STR(1558) }), link_forums_bugs, /*""*/ STR(0), null_, icons_BUG, null_, ID_popup_open_url, true });
				list_item_add({ text_get({ /*"toolbarhelpforums"*/ STR(1559) }), link_forums, /*""*/ STR(0), null_, icons_COMMENTS, null_, ID_popup_open_url });
				break;
			}
			
			case 1052: // keybind
			{
				list_item_add({ text_get({ /*"contextmenurestorekeybind"*/ STR(1560) }), sVar(context_menu_value), /*""*/ STR(0), null_, icons_RESET, null_, ID_keybind_restore });
				break;
			}
	...
	IntType list_init_end(ScopeAny self)
	{
		...
		if (ds_list_size(ObjType(obj_list, list)->item) > IntType(0) && ObjType(obj_list_item, DsList(ObjType(obj_list, list)->item).Value(IntType(0)))->divider > 0)
	...
	IntType list_item_add(VarArgs argument)
	{
		IntType argument_count = argument.Size();
		IntType item;
		VarType name, value, caption, thumbnail, lefticon, righticon, script, divider, interact;
		name = argument[IntType(0)];
		value = argument[IntType(1)];
		if (argument_count > IntType(2))
			caption = argument[IntType(2)];
		else
			caption = /*""*/ STR(0);
		...
		{
			thumbnail = argument[IntType(3)];
			lefticon = argument[IntType(4)];
			righticon = argument[IntType(5)];
			script = argument[IntType(6)];
		}
		if (argument_count > IntType(7))
			divider = argument[IntType(7)];
		if (argument_count > IntType(8))
			interact = argument[IntType(8)];
		item = (new obj_list_item)->id;
	...
	void list_item_add_action(VarArgs argument)
	{
		IntType argument_count = argument.Size();
		VarType item, name, script, active, value, icon, side, tip, sprite;
		IntType list;
		item = argument[IntType(0)];
		name = argument[IntType(1)];
		script = argument[IntType(2)];
		active = argument[IntType(3)];
		value = argument[IntType(4)];
		icon = argument[IntType(5)];
		side = argument[IntType(6)];
		sprite = null_;
		tip = name;
		if (argument_count > IntType(7))
		{
			tip = argument[IntType(7)];
			sprite = argument[IntType(8)];
		}
		withOne (Object, item, noone)
		{
			if (side == /*"right"*/ STR(189))
			{
				if (sInt(actions_right) == null_)
					sInt(actions_right) = ds_list_create();
				list = sInt(actions_right);
			}
			else
			{
				if (sInt(actions_left) == null_)
					sInt(actions_left) = ds_list_create();
				list = sInt(actions_left);
			}
	...
	RealType list_item_draw(ScopeAny self, VarArgs argument)
	{
		...
		if (animation > 0)
		{
			microani_set(string(item), /*""*/ STR(0), idVar(item, hover), idVar(item, hover) > 0 && sBool(mouse_left) && idVar(item, interact) > 0, toggled > 0 && idVar(item, interact) > 0, idVar(item, disabled));
			microani_update({ idVar(item, hover), idVar(item, hover) > 0 && sBool(mouse_left) && idVar(item, interact) > 0, toggled > 0 && idVar(item, interact) > 0, idVar(item, disabled) });
		...
		mousehover = app_mouse_box(self, xx, yy, width, height) && !(idVar(item, disabled) > 0) && sBool(content_mouseon);
		hover = mousehover;
		...
		if (idVar(item, icon_right) != null_)
		{
			rightp += IntType(4);
			if (idVar(item, icon_right) != -IntType(1))
				draw_image({ ID_spr_icons, idVar(item, icon_right), (xx + width - rightp) - iconsize / 2.0, middley, IntType(1), IntType(1), iconcolor, iconalpha });
			rightp += IntType(24);
			components++;
		}
		...
		if (hover && idVar(item, interact) > 0)
	...
	void load_start(ScopeAny self, IntType object, IntType script)
	{
		...
		sVar(window_busy) = /*"popup"*/ STR(1561) + idVar(sInt(popup), name);
	}
	...
	void marker_editor_draw(ScopeAny self)
	{
		...
		if (draw_textfield(self, { /*"timelinemarkerlabel"*/ STR(1648), sVar(dx), sVar(dy), sVar(settings_menu_w) - IntType(24), IntType(24), idInt(sVar(timeline), tbx_marker_name), null_ }))
		...
		tab_next(self);
		VarType text, color;
		text = text_get({ /*"timelinemarkercolor"*/ STR(1450) + string(idVar(sVar(timeline_marker_edit), color)) });
		color = ObjType(obj_theme, sInt(setting_theme))->accent_list.Value(idVar(sVar(timeline_marker_edit), color));
		tab_control_menu(self);
		draw_button_menu(self, { /*"timelinemarkercolor"*/ STR(1450), e_menu_LIST, sVar(dx), sVar(dy), sVar(settings_menu_w) - IntType(24), IntType(24), idVar(sVar(timeline_marker_edit), color), text, ID_action_tl_marker_color, false, ID_spr_16, null_, /*""*/ STR(0), color, IntType(1) });
		tab_next(self);
	...
	void marker_event_create(Scope<obj_marker> self)
	{
		...
		self->name = text_get({ /*"timelinemarkernew"*/ STR(47) });
		self->edit_pos = null_;
		self->save_id = /*""*/ STR(0);
	...
	{
		log({ /*"External library"*/ STR(1259), path });
		global::lib_math_simplex1d = external_define({ path, /*"simplex1D"*/ STR(1649), dll_cdecl, ty_real, IntType(1), ty_real });
		global::lib_math_simplex2d = external_define({ path, /*"simplex2D"*/ STR(1650), dll_cdecl, ty_real, IntType(2), ty_real, ty_real });
		global::lib_math_simplex3d = external_define({ path, /*"simplex3D"*/ STR(1651), dll_cdecl, ty_real, IntType(3), ty_real, ty_real, ty_real });
		global::lib_math_simplex4d = external_define({ path, /*"simplex4D"*/ STR(1652), dll_cdecl, ty_real, IntType(4), ty_real, ty_real, ty_real, ty_real });
	}
	...
	RealType menu_add_timeline(VarType tl, RealType level, VarType menu)
	{
		if (tl == global::tl_edit && !ObjType(obj_menu, menu)->menu_include_tl_edit)
			return IntType(0);
		if (tl == null_)
			list_item_add({ text_get({ /*"timelinenone"*/ STR(1653) }), tl });
		else
		{
			list_item_add({ string_remove_newline(idVar(tl, display_name)), tl });
			if (ds_list_size(idInt(tl, tree_list)))
				list_item_add_action({ global::list_item_last, string(tl) + /*"extend"*/ STR(1654), ID_menu_item_set_extend, idVar(tl, tree_extend), tl, null_, /*"left"*/ STR(188), (idVar(tl, tree_extend) > 0) ? /*"tooltiptlcollapse"*/ STR(1655) : /*"tooltiptlexpand"*/ STR(1656), ID_spr_chevron_ani });
		}
		
		ObjType(obj_list_item, global::list_item_last)->indent = max({ IntType(0), level * IntType(32) });
		if (tl != null_ && !(idVar(tl, tree_extend) > 0))
			return IntType(0);
		if (tl == null_)
			tl = global::_app->id;
		for (IntType t = IntType(0); t < ds_list_size(idInt(tl, tree_list)); t++)
			menu_add_timeline(DsList(idInt(tl, tree_list)).Value(t), level + IntType(1), menu);
		return 0.0;
	}
	...
	IntType menu_biome_init(ScopeAny self, VarType menu)
	{
		...
		if (ObjType(obj_biome, selectedbiome)->biome_base != null_ && ObjType(obj_menu, menu)->menu_ani == IntType(0))
		...
		for (IntType b = IntType(0); b < ds_list_size(global::biome_list); b++)
		{
			...
			menu_add_item({ ObjType(obj_biome, biome)->name, minecraft_asset_get_name(/*"biome"*/ STR(1657), ObjType(obj_biome, biome)->name) });
			if (ObjType(obj_biome, biome)->biome_variants != null_ && ds_list_size(ObjType(obj_biome, biome)->biome_variants) > IntType(0))
			{
				list_item_add_action({ global::list_item_last, string(biome) + /*"extend"*/ STR(1654), ID_menu_item_set_extend, ObjType(obj_biome, biome)->variants_extend, biome, null_, /*"left"*/ STR(188), (ObjType(obj_biome, biome)->variants_extend > 0) ? /*"tooltiptlcollapse"*/ STR(1655) : /*"tooltiptlexpand"*/ STR(1656), ID_spr_chevron_ani });
				if (ObjType(obj_biome, biome)->variants_extend > 0)
				{
					for (IntType v = IntType(0); v < ds_list_size(ObjType(obj_biome, biome)->biome_variants); v++)
					{
						if (ObjType(obj_biome, DsList(ObjType(obj_biome, biome)->biome_variants).Value(v))->name == /*"normal"*/ STR(601))
							continue;
						menu_add_item({ ObjType(obj_biome, DsList(ObjType(obj_biome, biome)->biome_variants).Value(v))->name, minecraft_asset_get_name(/*"biome"*/ STR(1657), ObjType(obj_biome, DsList(ObjType(obj_biome, biome)->biome_variants).Value(v))->name) });
	...
	void menu_draw(ScopeAny self)
	{
		...
		for (IntType i = IntType(0); i < ds_list_size(sInt(menu_list)); i++)
		{
			...
			if (ObjType(obj_menu, m)->menu_window != window_get_current())
				continue;
			if (ObjType(obj_menu, m)->menu_ani_type == /*"hide"*/ STR(719))
			{
				ObjType(obj_menu, m)->menu_ani -= test_reduced_motion(IntType(1), (0.06 * global::delta));
				...
				if (ObjType(obj_menu, m)->menu_ani_type == /*"show"*/ STR(720))
				{
					ObjType(obj_menu, m)->menu_ani += test_reduced_motion(IntType(1), (0.06 * global::delta));
			...
			if (ObjType(obj_menu, m)->menu_steps == IntType(0))
				draw_set_alpha(0.0);
			ObjType(obj_menu, m)->menu_ani_ease = ease(((ObjType(obj_menu, m)->menu_ani_type == /*"show"*/ STR(720)) ? /*"easeoutexpo"*/ STR(554) : /*"easeinexpo"*/ STR(553)), ObjType(obj_menu, m)->menu_ani);
			...
			if (sVar(window_busy) == /*"menu"*/ STR(1040) && ObjType(obj_menu, m)->menu_ani_type != /*"hide"*/ STR(719) && menu_active)
			...
			switch ((IntType)ObjType(obj_menu, m)->menu_type)
			{
				...
				case e_menu_BIOME:
				{
					...
					for (IntType j = IntType(0); j < ObjType(obj_menu, m)->menu_amount; j++)
					{
						...
						if ((ObjType(obj_menu, m)->menu_value == ObjType(obj_list_item, item)->value) && !(ObjType(obj_list_item, item)->toggled > 0))
						{
							ObjType(obj_list_item, item)->toggled = true;
							updatewidth = true;
						}
						list_item_draw(self, { item, menu_x_draw, itemy, menu_wid_draw, ObjType(obj_menu, m)->menu_item_h, false, ObjType(obj_menu, m)->menu_margin, -ObjType(obj_scrollbar, ObjType(obj_menu, m)->menu_scroll_horizontal)->value });
					...
					if (ObjType(obj_menu, m)->menu_type == e_menu_LIST || ObjType(obj_menu, m)->menu_type == e_menu_LIST_SEAMLESS)
					{
						...
						if ((ObjType(obj_menu, m)->menu_x + ObjType(obj_menu, m)->menu_w > (ObjType(obj_menu, m)->content_x + ObjType(obj_menu, m)->content_width)) && ObjType(obj_menu, m)->menu_x > sReal(window_width) / 2.0)
				...
				{
					clip_begin(IntType(0), sVar(content_y), sReal(window_width), sVar(content_height));
					...
					if (ObjType(obj_menu, m)->menu_steps == IntType(0))
					{
						...
						if (sVar(content_y) + ObjType(obj_menu, m)->menu_height > sReal(window_height))
			...
			if (!(ObjType(obj_scrollbar, ObjType(obj_menu, m)->menu_scroll_vertical)->needed && ObjType(obj_scrollbar, ObjType(obj_menu, m)->menu_scroll_vertical)->mouseon) && !(ObjType(obj_scrollbar, ObjType(obj_menu, m)->menu_scroll_horizontal)->needed && ObjType(obj_scrollbar, ObjType(obj_menu, m)->menu_scroll_horizontal)->mouseon) && sBool(mouse_left_released) && menu_active && ObjType(obj_menu, m)->menu_ani_type != /*"hide"*/ STR(719))
			{
				BoolType close = false;
				if (contentmenu > 0)
				{
					if (!sBool(content_mouseon) && sVar(window_focus) == /*""*/ STR(0))
						close = true;
				}
				else
				{
				...
				{
					ObjType(obj_menu, m)->menu_ani = IntType(1);
					ObjType(obj_menu, m)->menu_ani_type = /*"hide"*/ STR(719);
					sVar(window_busy) = (ds_list_size(sInt(menu_list)) > IntType(1) ? /*"menu"*/ STR(1040) : /*""*/ STR(0));
				}
			}
			if (ObjType(obj_menu, m)->menu_steps == IntType(0))
				draw_set_alpha(1.0);
			ObjType(obj_menu, m)->menu_steps++;
			if (sVar(window_busy) == /*""*/ STR(0) && ObjType(obj_menu, m)->menu_ani_type != /*"hide"*/ STR(719) && menu_active)
				sVar(window_busy) = /*"menu"*/ STR(1040);
		}
