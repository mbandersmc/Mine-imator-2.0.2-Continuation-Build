/*
	...
	[ Generated on 2023.04.20 09:28:22 ]
*/
...
namespace CppProject
{
	...
	void popup_about_draw(ScopeAny self)
	{
		...
		draw_button_text(self, { text_get({ /*"aboutminecraft"*/ STR(1919) }), mctextx, sVar(dy) + IntType(98) + IntType(19), ID_popup_open_url, link_minecraft, link_minecraft });
		...
		sVar(dy) += IntType(26);
		draw_button_text(self, { /*"David"*/ STR(1927), sVar(dx), sVar(dy), ID_popup_open_url, link_david, link_david, sInt(font_label) });
		sVar(dy) += IntType(19);
		...
		sVar(dy) += IntType(26);
		draw_button_text(self, { /*"David Andrei"*/ STR(1933), sVar(dx), sVar(dy), ID_popup_open_url, link_david, link_david, sInt(font_label) });
		sVar(dx) += IntType(130) + IntType(24);
		sVar(dy) = sVar(content_y) + IntType(176);
		sVar(dy) += IntType(12);
