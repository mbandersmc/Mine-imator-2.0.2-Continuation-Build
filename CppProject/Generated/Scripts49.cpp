...
namespace CppProject
{
	...
	void render_startup(ScopeAny self)
	{
		...
		if (!file_exists_lib(render_default_file))
		{
			...
			project_save_done();
			log({ /*"Saved default render settings"*/ STR(2455), render_default_file });
		}
	}
	...
	void render_update_text()
	{
		...
		withAll (obj_preview, noone)
			if (instance_exists(self->select) && Obj(self->select)->subAssetId != ID_obj_resource && idVar(self->select, type) == e_temp_type_TEXT)
				render_generate_text(ScopeAny(self), { /*"AaBbCc"*/ STR(2038), idVar(self->select, text_font), idVar(self->select, text_3d) });
	...
	void render_watermark_image(VarArgs argument)
	{
		IntType argument_count = argument.Size();
		VarType draw_width, draw_height;
		...
		{
			draw_width = argument[IntType(0)];
			draw_height = argument[IntType(1)];
		}
		IntType sprite;
		...
		else
		{
			scale = .33;
			opacity = IntType(1);
			halign = /*"right"*/ STR(189);
			valign = /*"bottom"*/ STR(186);
			padding = IntType(0);
			sprite = ID_spr_watermark;
		}
	...
	RealType render_world_block(VarArgs argument)
	{
		IntType argument_count = argument.Size();
		VarType vbuffer, res, rotate, size, temp;
		vbuffer = argument[IntType(0)];
		res = argument[IntType(1)];
		if (argument_count > IntType(2))
		{
			rotate = argument[IntType(2)];
			size = argument[IntType(3)];
		}
		else
			rotate = false;
		
		if (argument_count > IntType(4))
			temp = argument[IntType(4)];
		else
			temp = null_;
		...
		tex = ObjType(obj_resource, res.Value(IntType(0)))->block_sheet_texture;
		texmat = ObjType(obj_resource, res.Value(IntType(1)))->block_sheet_texture_material;
		texnormal = ObjType(obj_resource, res.Value(IntType(2)))->block_sheet_tex_normal;
		render_set_uniform_int(/*"uMaterialFormat"*/ STR(2456), ObjType(obj_resource, res.Value(IntType(1)))->material_format);
		texprev = tex;
		texmatprev = texmat;
		texnormalprev = texnormal;
		if (ObjType(obj_resource, res.Value(IntType(0)))->block_sheet_ani_texture != null_)
			texani = ObjType(obj_resource, res.Value(IntType(0)))->block_sheet_ani_texture.Value(block_texture_get_frame());
		else
			texani = ObjType(obj_resource, global::mc_res)->block_sheet_ani_texture.Value(block_texture_get_frame());
		
		texanimatsheet = (ObjType(obj_resource, res.Value(IntType(1)))->block_sheet_ani_texture_material == null_);
		if (!texanimatsheet)
			texanimat = ObjType(obj_resource, res.Value(IntType(1)))->block_sheet_ani_texture_material.Value(block_texture_get_frame());
		else
			texanimat = ObjType(obj_resource, global::mc_res)->block_sheet_ani_texture_material.Value(block_texture_get_frame());
		
		if (ObjType(obj_resource, res.Value(IntType(2)))->block_sheet_ani_tex_normal != null_)
			texaninormal = ObjType(obj_resource, res.Value(IntType(2)))->block_sheet_ani_tex_normal.Value(block_texture_get_frame());
		else
		...
		render_set_texture(texnormal, /*"Normal"*/ STR(2458));
		if (rotate > 0)
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1874), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_grass), global::shader_blend_alpha);
			vbuffer_render({ vbuffer[e_block_depth_DEPTH0][e_block_vbuffer_GRASS] });
			render_set_uniform_color(/*"uBlendColor"*/ STR(1874), blend, global::shader_blend_alpha);
		}
		if (!vbuffer_is_empty(vbuffer[e_block_depth_DEPTH0][e_block_vbuffer_ANIMATED]))
		{
			...
			{
				render_set_texture(texanimat, /*"Material"*/ STR(2457));
				texmatprev = texanimat;
			}
			if (texaninormal != texnormalprev)
			{
				render_set_texture(texaninormal, /*"Normal"*/ STR(2458));
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1874), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_foliage), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1874), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_leaves_oak), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1874), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_leaves_spruce), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1874), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_leaves_birch), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1874), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_leaves_jungle), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1874), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_leaves_acacia), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1874), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_leaves_dark_oak), global::shader_blend_alpha);
		...
		{
			render_set_uniform_color(/*"uBlendColor"*/ STR(1874), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_leaves_mangrove), global::shader_blend_alpha);
		...
		if (!vbuffer_is_empty(vbuffer[e_block_depth_DEPTH2][e_block_vbuffer_WATER]))
		{
			...
			{
				render_set_texture(texani);
				render_set_uniform_color(/*"uBlendColor"*/ STR(1874), color_multiply(blend, ObjType(obj_resource, res.Value(IntType(0)))->color_water), global::shader_blend_alpha);
				render_set_uniform_int(/*"uIsWater"*/ STR(2462), IntType(1));
