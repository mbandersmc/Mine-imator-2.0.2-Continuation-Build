...
namespace CppProject
{
	void app_startup_keybinds()
	{
		...
		keybind_register(/*"projectnew"*/ STR(247), e_keybind_PROJECT_NEW, keybind_new(/*"N"*/ STR(248), true));
		keybind_register(/*"projectopen"*/ STR(249), e_keybind_PROJECT_OPEN, keybind_new(/*"O"*/ STR(250), true));
		keybind_register(/*"projectsave"*/ STR(251), e_keybind_PROJECT_SAVE, keybind_new(/*"S"*/ STR(252), true));
		keybind_register(/*"projectsaveas"*/ STR(253), e_keybind_PROJECT_SAVE_AS, keybind_new(/*"S"*/ STR(252), true, true));
		keybind_register(/*"importasset"*/ STR(254), e_keybind_IMPORT_ASSET, keybind_new(/*"I"*/ STR(255), true));
		keybind_register(/*"undo"*/ STR(256), e_keybind_UNDO, keybind_new(/*"Z"*/ STR(257), true));
		keybind_register(/*"redo"*/ STR(258), e_keybind_REDO, keybind_new(/*"Y"*/ STR(259), true));
		keybind_register(/*"timelinedelete"*/ STR(260), e_keybind_TIMELINE_DELETE, keybind_new(/*"R"*/ STR(261), true));
		keybind_register(/*"timelineduplicate"*/ STR(262), e_keybind_TIMELINE_DUPLICATE, keybind_new(/*"D"*/ STR(263), true));
		keybind_register(/*"timelineselect"*/ STR(264), e_keybind_TIMELINE_SELECT, keybind_new(/*"A"*/ STR(265), true));
		keybind_register(/*"timelinehide"*/ STR(266), e_keybind_TIMELINE_HIDE, keybind_new(/*"H"*/ STR(267), true));
		keybind_register(/*"timelineshowhidden"*/ STR(268), e_keybind_TIMELINE_SHOW_HIDDEN, keybind_new(/*"H"*/ STR(267), true, false, true));
		keybind_register(/*"createfolder"*/ STR(269), e_keybind_CREATE_FOLDER, keybind_new(/*"F"*/ STR(270), true));
		keybind_register(/*"keyframescreate"*/ STR(271), e_keybind_KEYFRAMES_CREATE, keybind_new(/*"Q"*/ STR(272), true));
		keybind_register(/*"keyframescopy"*/ STR(273), e_keybind_KEYFRAMES_COPY, keybind_new(/*"C"*/ STR(274), true));
		keybind_register(/*"keyframescut"*/ STR(275), e_keybind_KEYFRAMES_CUT, keybind_new(/*"X"*/ STR(276), true));
		keybind_register(/*"keyframespaste"*/ STR(277), e_keybind_KEYFRAMES_PASTE, keybind_new(/*"V"*/ STR(278), true));
		keybind_register(/*"keyframesdelete"*/ STR(279), e_keybind_KEYFRAMES_DELETE, keybind_new(vk_delete));
		keybind_register(/*"play"*/ STR(280), e_keybind_PLAY, keybind_new(vk_space));
		keybind_register(/*"playbeginning"*/ STR(281), e_keybind_PLAY_BEGINNING, keybind_new(vk_enter));
		keybind_register(/*"markerleft"*/ STR(282), e_keybind_MARKER_LEFT, keybind_new(vk_left));
		keybind_register(/*"markerright"*/ STR(283), e_keybind_MARKER_RIGHT, keybind_new(vk_right));
		keybind_register(/*"frameprevious"*/ STR(284), e_keybind_FRAME_PREVIOUS, keybind_new(vk_left, false, true));
		keybind_register(/*"framenext"*/ STR(285), e_keybind_FRAME_NEXT, keybind_new(vk_right, false, true));
		keybind_register(/*"rendermode"*/ STR(286), e_keybind_RENDER_MODE, keybind_new(vk_f5));
		keybind_register(/*"secondaryview"*/ STR(287), e_keybind_SECONDARY_VIEW, keybind_new(vk_f6));
		keybind_register(/*"particlesspawn"*/ STR(288), e_keybind_PARTICLES_SPAWN, keybind_new(/*"X"*/ STR(276)));
		keybind_register(/*"particlesclear"*/ STR(289), e_keybind_PARTICLES_CLEAR, keybind_new(/*"C"*/ STR(274)));
		keybind_register(/*"toolselect"*/ STR(290), e_keybind_TOOL_SELECT, keybind_new(/*"W"*/ STR(291)));
		keybind_register(/*"toolmove"*/ STR(292), e_keybind_TOOL_MOVE, keybind_new(/*"G"*/ STR(293)));
		keybind_register(/*"toolrotate"*/ STR(294), e_keybind_TOOL_ROTATE, keybind_new(/*"R"*/ STR(261)));
		keybind_register(/*"toolscale"*/ STR(295), e_keybind_TOOL_SCALE, keybind_new(/*"S"*/ STR(252)));
		keybind_register(/*"toolbend"*/ STR(296), e_keybind_TOOL_BEND, keybind_new(/*"B"*/ STR(297)));
		keybind_register(/*"tooltransform"*/ STR(298), e_keybind_TOOL_TRANSFORM, keybind_new(/*"T"*/ STR(299)));
		keybind_register(/*"snap"*/ STR(300), e_keybind_SNAP, keybind_new(/*"F"*/ STR(270)));
		keybind_register(/*"camforward"*/ STR(301), e_keybind_CAM_FORWARD, keybind_new(/*"W"*/ STR(291)), true);
		keybind_register(/*"camleft"*/ STR(302), e_keybind_CAM_LEFT, keybind_new(/*"A"*/ STR(265)), true);
		keybind_register(/*"camback"*/ STR(303), e_keybind_CAM_BACK, keybind_new(/*"S"*/ STR(252)), true);
		keybind_register(/*"camright"*/ STR(304), e_keybind_CAM_RIGHT, keybind_new(/*"D"*/ STR(263)), true);
		keybind_register(/*"camascend"*/ STR(305), e_keybind_CAM_ASCEND, keybind_new(/*"E"*/ STR(306)), true);
		keybind_register(/*"camdescend"*/ STR(307), e_keybind_CAM_DESCEND, keybind_new(/*"Q"*/ STR(272)), true);
		keybind_register(/*"camrollforward"*/ STR(308), e_keybind_CAM_ROLL_FORWARD, keybind_new(/*"Z"*/ STR(257)), true);
		keybind_register(/*"camrollback"*/ STR(309), e_keybind_CAM_ROLL_BACK, keybind_new(/*"C"*/ STR(274)), true);
		keybind_register(/*"camrollreset"*/ STR(310), e_keybind_CAM_ROLL_RESET, keybind_new(/*"X"*/ STR(276)), true);
		keybind_register(/*"camreset"*/ STR(311), e_keybind_CAM_RESET, keybind_new(/*"R"*/ STR(261)), true);
		keybind_register(/*"camfast"*/ STR(312), e_keybind_CAM_FAST, keybind_new(vk_space), true);
		keybind_register(/*"camslow"*/ STR(313), e_keybind_CAM_SLOW, keybind_new(null_, false, true), true);
		keybind_register(/*"camviewtimeline"*/ STR(314), e_keybind_CAM_VIEW_TIMELINE, keybind_new(/*"V"*/ STR(278)));
	...
	void app_startup_lists(ScopeAny self)
	{
		...
		ds_list_add({ global::value_name_list, /*"POS_X"*/ STR(315), /*"POS_Y"*/ STR(316), /*"POS_Z"*/ STR(317), /*"ROT_X"*/ STR(318), /*"ROT_Y"*/ STR(319), /*"ROT_Z"*/ STR(320), /*"SCA_X"*/ STR(321), /*"SCA_Y"*/ STR(322), /*"SCA_Z"*/ STR(323), /*"BEND_ANGLE"*/ STR(324), /*"BEND_ANGLE_X"*/ STR(325), /*"BEND_ANGLE_Y"*/ STR(326), /*"BEND_ANGLE_Z"*/ STR(327), /*"ALPHA"*/ STR(328), /*"RGB_ADD"*/ STR(329), /*"RGB_SUB"*/ STR(330), /*"RGB_MUL"*/ STR(331), /*"HSB_ADD"*/ STR(332), /*"HSB_SUB"*/ STR(333), /*"HSB_MUL"*/ STR(334), /*"MIX_COLOR"*/ STR(335), /*"GLOW_COLOR"*/ STR(336), /*"MIX_PERCENT"*/ STR(337), /*"EMISSIVE"*/ STR(338), /*"METALLIC"*/ STR(339), /*"ROUGHNESS"*/ STR(340), /*"SUBSURFACE"*/ STR(341), /*"SUBSURFACE_RADIUS_RED"*/ STR(342), /*"SUBSURFACE_RADIUS_GREEN"*/ STR(343), /*"SUBSURFACE_RADIUS_BLUE"*/ STR(344), /*"SUBSURFACE_COLOR"*/ STR(345), /*"WIND_INFLUENCE"*/ STR(346), /*"SPAWN"*/ STR(347), /*"FREEZE"*/ STR(348), /*"CLEAR"*/ STR(349), /*"CUSTOM_SEED"*/ STR(350), /*"SEED"*/ STR(351), /*"ATTRACTOR"*/ STR(352), /*"FORCE"*/ STR(353), /*"FORCE_DIRECTIONAL"*/ STR(354), /*"FORCE_VORTEX"*/ STR(355), /*"LIGHT_COLOR"*/ STR(356), /*"LIGHT_STRENGTH"*/ STR(357), /*"LIGHT_SPECULAR_STRENGTH"*/ STR(358), /*"LIGHT_SIZE"*/ STR(359), /*"LIGHT_RANGE"*/ STR(360), /*"LIGHT_FADE_SIZE"*/ STR(361), /*"LIGHT_SPOT_RADIUS"*/ STR(362), /*"LIGHT_SPOT_SHARPNESS"*/ STR(363), /*"CAM_FOV"*/ STR(364), /*"CAM_BLADE_AMOUNT"*/ STR(365), /*"CAM_BLADE_ANGLE"*/ STR(366), /*"CAM_LIGHT_MANAGEMENT"*/ STR(367), /*"CAM_TONEMAPPER"*/ STR(368), /*"CAM_EXPOSURE"*/ STR(369), /*"CAM_GAMMA"*/ STR(370), /*"CAM_ROTATE"*/ STR(371), /*"CAM_ROTATE_DISTANCE"*/ STR(372), /*"CAM_ROTATE_ANGLE_XY"*/ STR(373), /*"CAM_ROTATE_ANGLE_Z"*/ STR(374), /*"CAM_SHAKE"*/ STR(375), /*"CAM_SHAKE_MODE"*/ STR(376), /*"CAM_SHAKE_STRENGTH_X"*/ STR(377), /*"CAM_SHAKE_STRENGTH_Y"*/ STR(378), /*"CAM_SHAKE_STRENGTH_Z"*/ STR(379), /*"CAM_SHAKE_SPEED_X"*/ STR(380), /*"CAM_SHAKE_SPEED_Y"*/ STR(381), /*"CAM_SHAKE_SPEED_Z"*/ STR(382), /*"CAM_DOF"*/ STR(383), /*"CAM_DOF_DEPTH"*/ STR(384), /*"CAM_DOF_RANGE"*/ STR(385), /*"CAM_DOF_FADE_SIZE"*/ STR(386), /*"CAM_DOF_BLUR_SIZE"*/ STR(387), /*"CAM_DOF_BLUR_RATIO"*/ STR(388), /*"CAM_DOF_BIAS"*/ STR(389), /*"CAM_DOF_THRESHOLD"*/ STR(390), /*"CAM_DOF_GAIN"*/ STR(391), /*"CAM_DOF_FRINGE"*/ STR(392), /*"CAM_DOF_FRINGE_ANGLE_RED"*/ STR(393), /*"CAM_DOF_FRINGE_ANGLE_GREEN"*/ STR(394), /*"CAM_DOF_FRINGE_ANGLE_BLUE"*/ STR(395), /*"CAM_DOF_FRINGE_RED"*/ STR(396), /*"CAM_DOF_FRINGE_GREEN"*/ STR(397), /*"CAM_DOF_FRINGE_BLUE"*/ STR(398), /*"CAM_BLOOM"*/ STR(399), /*"CAM_BLOOM_THRESHOLD"*/ STR(400), /*"CAM_BLOOM_INTENSITY"*/ STR(401), /*"CAM_BLOOM_RADIUS"*/ STR(402), /*"CAM_BLOOM_RATIO"*/ STR(403), /*"CAM_BLOOM_BLEND"*/ STR(404), /*"CAM_LENS_DIRT"*/ STR(405), /*"CAM_LENS_DIRT_BLOOM"*/ STR(406), /*"CAM_LENS_DIRT_GLOW"*/ STR(407), /*"CAM_LENS_DIRT_RADIUS"*/ STR(408), /*"CAM_LENS_DIRT_INTENSITY"*/ STR(409), /*"CAM_LENS_DIRT_POWER"*/ STR(410), /*"CAM_COLOR_CORRECTION"*/ STR(411), /*"CAM_CONTRAST"*/ STR(412), /*"CAM_BRIGHTNESS"*/ STR(413), /*"CAM_SATURATION"*/ STR(414), /*"CAM_VIBRANCE"*/ STR(415), /*"CAM_COLOR_BURN"*/ STR(416), /*"CAM_GRAIN"*/ STR(417), /*"CAM_GRAIN_STRENGTH"*/ STR(418), /*"CAM_GRAIN_SATURATION"*/ STR(419), /*"CAM_GRAIN_SIZE"*/ STR(420), /*"CAM_VIGNETTE"*/ STR(421), /*"CAM_VIGNETTE_RADIUS"*/ STR(422), /*"CAM_VIGNETTE_SOFTNESS"*/ STR(423), /*"CAM_VIGNETTE_STRENGTH"*/ STR(424), /*"CAM_VIGNETTE_COLOR"*/ STR(425), /*"CAM_CA"*/ STR(426), /*"CAM_CA_BLUR_AMOUNT"*/ STR(427), /*"CAM_CA_DISTORT_CHANNELS"*/ STR(428), /*"CAM_CA_RED_OFFSET"*/ STR(429), /*"CAM_CA_GREEN_OFFSET"*/ STR(430), /*"CAM_CA_BLUE_OFFSET"*/ STR(431), /*"CAM_DISTORT"*/ STR(432), /*"CAM_DISTORT_REPEAT"*/ STR(433), /*"CAM_DISTORT_ZOOM_AMOUNT"*/ STR(434), /*"CAM_DISTORT_AMOUNT"*/ STR(435), /*"CAM_SIZE_USE_PROJECT"*/ STR(436), /*"CAM_SIZE_KEEP_ASPECT_RATIO"*/ STR(437), /*"CAM_WIDTH"*/ STR(438), /*"CAM_HEIGHT"*/ STR(439), /*"BG_IMAGE_SHOW"*/ STR(440), /*"BG_IMAGE_ROTATION"*/ STR(441), /*"BG_SKY_MOON_PHASE"*/ STR(442), /*"BG_SKY_TIME"*/ STR(443), /*"BG_SKY_ROTATION"*/ STR(444), /*"BG_SUNLIGHT_STRENGTH"*/ STR(445), /*"BG_SUNLIGHT_ANGLE"*/ STR(446), /*"BG_SKY_SUN_ANGLE"*/ STR(447), /*"BG_SKY_SUN_SCALE"*/ STR(448), /*"BG_SKY_MOON_ANGLE"*/ STR(449), /*"BG_SKY_MOON_SCALE"*/ STR(450), /*"BG_TWILIGHT"*/ STR(451), /*"BG_SKY_CLOUDS_SHOW"*/ STR(452), /*"BG_SKY_CLOUDS_SPEED"*/ STR(453), /*"BG_SKY_CLOUDS_HEIGHT"*/ STR(454), /*"BG_SKY_CLOUDS_OFFSET"*/ STR(455), /*"BG_GROUND_SHOW"*/ STR(456), /*"BG_GROUND_SLOT"*/ STR(457), /*"BG_GROUND_DIRECTION"*/ STR(458), /*"BG_BIOME"*/ STR(459), /*"BG_SKY_COLOR"*/ STR(460), /*"BG_SKY_CLOUDS_COLOR"*/ STR(461), /*"BG_SUNLIGHT_COLOR"*/ STR(462), /*"BG_AMBIENT_COLOR"*/ STR(463), /*"BG_NIGHT_COLOR"*/ STR(464), /*"BG_GRASS_COLOR"*/ STR(465), /*"BG_FOLIAGE_COLOR"*/ STR(466), /*"BG_WATER_COLOR"*/ STR(467), /*"BG_LEAVES_OAK_COLOR"*/ STR(468), /*"BG_LEAVES_SPRUCE_COLOR"*/ STR(469), /*"BG_LEAVES_BIRCH_COLOR"*/ STR(470), /*"BG_LEAVES_JUNGLE_COLOR"*/ STR(471), /*"BG_LEAVES_ACACIA_COLOR"*/ STR(472), /*"BG_LEAVES_DARK_OAK_COLOR"*/ STR(473), /*"BG_LEAVES_MANGROVE_COLOR"*/ STR(474), /*"BG_FOG_SHOW"*/ STR(475), /*"BG_FOG_SKY"*/ STR(476), /*"BG_FOG_CUSTOM_COLOR"*/ STR(477), /*"BG_FOG_COLOR"*/ STR(478), /*"BG_FOG_CUSTOM_OBJECT_COLOR"*/ STR(479), /*"BG_FOG_OBJECT_COLOR"*/ STR(480), /*"BG_FOG_DISTANCE"*/ STR(481), /*"BG_FOG_SIZE"*/ STR(482), /*"BG_FOG_HEIGHT"*/ STR(483), /*"BG_WIND"*/ STR(484), /*"BG_WIND_SPEED"*/ STR(485), /*"BG_WIND_STRENGTH"*/ STR(486), /*"BG_WIND_DIRECTION"*/ STR(487), /*"BG_WIND_DIRECTIONAL_SPEED"*/ STR(488), /*"BG_WIND_DIRECTIONAL_STRENGTH"*/ STR(489), /*"BG_TEXTURE_ANI_SPEED"*/ STR(490), /*"TEXTURE_OBJ"*/ STR(491), /*"TEXTURE_MATERIAL_OBJ"*/ STR(492), /*"TEXTURE_NORMAL_OBJ"*/ STR(493), /*"SOUND_OBJ"*/ STR(494), /*"SOUND_VOLUME"*/ STR(495), /*"SOUND_PITCH"*/ STR(496), /*"SOUND_START"*/ STR(497), /*"SOUND_END"*/ STR(498), /*"TEXT"*/ STR(499), /*"TEXT_FONT"*/ STR(500), /*"TEXT_HALIGN"*/ STR(501), /*"TEXT_VALIGN"*/ STR(502), /*"TEXT_AA"*/ STR(503), /*"TEXT_OUTLINE"*/ STR(504), /*"TEXT_OUTLINE_COLOR"*/ STR(505), /*"CUSTOM_ITEM_SLOT"*/ STR(506), /*"ITEM_SLOT"*/ STR(507), /*"ITEM_NAME"*/ STR(508), /*"PATH_OBJ"*/ STR(509), /*"PATH_OFFSET"*/ STR(510), /*"PATH_POINT_ANGLE"*/ STR(511), /*"PATH_POINT_SCALE"*/ STR(512), /*"IK_TARGET"*/ STR(513), /*"IK_BLEND"*/ STR(514), /*"IK_TARGET_ANGLE"*/ STR(515), /*"IK_ANGLE_OFFSET"*/ STR(516), /*"VISIBLE"*/ STR(517), /*"TRANSITION"*/ STR(518), /*"EASE_IN_X"*/ STR(519), /*"EASE_IN_Y"*/ STR(520), /*"EASE_OUT_X"*/ STR(521), /*"EASE_OUT_Y"*/ STR(522) });
		...
		ds_list_add({ global::temp_type_name_list, /*"char"*/ STR(523), /*"spblock"*/ STR(524), /*"scenery"*/ STR(525), /*"item"*/ STR(526), /*"block"*/ STR(4), /*"bodypart"*/ STR(527), /*"particles"*/ STR(528), /*"text"*/ STR(104), /*"cube"*/ STR(3), /*"cone"*/ STR(529), /*"cylinder"*/ STR(530), /*"sphere"*/ STR(531), /*"surface"*/ STR(532), /*"model"*/ STR(8) });
		global::tl_type_name_list = ds_list_create();
		ds_list_add({ global::tl_type_name_list, /*"char"*/ STR(523), /*"spblock"*/ STR(524), /*"scenery"*/ STR(525), /*"item"*/ STR(526), /*"block"*/ STR(4), /*"bodypart"*/ STR(527), /*"particles"*/ STR(528), /*"text"*/ STR(104), /*"cube"*/ STR(3), /*"cone"*/ STR(529), /*"cylinder"*/ STR(530), /*"sphere"*/ STR(531), /*"surface"*/ STR(532), /*"model"*/ STR(8), /*"camera"*/ STR(126), /*"spotlight"*/ STR(533), /*"pointlight"*/ STR(534), /*"folder"*/ STR(535), /*"background"*/ STR(219), /*"audio"*/ STR(536), /*"path"*/ STR(537), /*"pathpoint"*/ STR(538), /*"shape"*/ STR(539), /*"lightsource"*/ STR(540) });
		global::res_type_name_list = ds_list_create();
		ds_list_add({ global::res_type_name_list, /*"pack"*/ STR(541), /*"packunzipped"*/ STR(542), /*"skin"*/ STR(543), /*"downloadskin"*/ STR(204), /*"itemsheet"*/ STR(544), /*"legacyblocksheet"*/ STR(545), /*"blocksheet"*/ STR(546), /*"scenery"*/ STR(525), /*"fromworld"*/ STR(547), /*"particlesheet"*/ STR(548), /*"texture"*/ STR(549), /*"font"*/ STR(550), /*"sound"*/ STR(551), /*"model"*/ STR(8) });
		global::transition_list = ds_list_create();
		ds_list_add({ global::transition_list, /*"linear"*/ STR(552), /*"instant"*/ STR(553), /*"bezier"*/ STR(554), /*"easeinquad"*/ STR(555), /*"easeoutquad"*/ STR(556), /*"easeinoutquad"*/ STR(557), /*"easeincubic"*/ STR(558), /*"easeoutcubic"*/ STR(559), /*"easeinoutcubic"*/ STR(560), /*"easeinquart"*/ STR(561), /*"easeoutquart"*/ STR(562), /*"easeinoutquart"*/ STR(563), /*"easeinquint"*/ STR(564), /*"easeoutquint"*/ STR(565), /*"easeinoutquint"*/ STR(566), /*"easeinsine"*/ STR(567), /*"easeoutsine"*/ STR(568), /*"easeinoutsine"*/ STR(569), /*"easeinexpo"*/ STR(570), /*"easeoutexpo"*/ STR(571), /*"easeinoutexpo"*/ STR(572), /*"easeincirc"*/ STR(573), /*"easeoutcirc"*/ STR(574), /*"easeinoutcirc"*/ STR(575), /*"easeinelastic"*/ STR(576), /*"easeoutelastic"*/ STR(577), /*"easeinoutelastic"*/ STR(578), /*"easeinback"*/ STR(579), /*"easeoutback"*/ STR(580), /*"easeinoutback"*/ STR(581), /*"easeinbounce"*/ STR(582), /*"easeoutbounce"*/ STR(583), /*"easeinoutbounce"*/ STR(584) });
		global::transition_list_order = ds_list_create();
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (!string_contains(DsList(global::transition_list).Value(i), /*"ease"*/ STR(585)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (string_contains(DsList(global::transition_list).Value(i), /*"easein"*/ STR(586)) && !string_contains(DsList(global::transition_list).Value(i), /*"easeinout"*/ STR(587)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (string_contains(DsList(global::transition_list).Value(i), /*"easeout"*/ STR(588)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (string_contains(DsList(global::transition_list).Value(i), /*"easeinout"*/ STR(587)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		log({ /*"Make transitions"*/ STR(589) });
		...
		log({ /*"Transitions OK"*/ STR(590) });
		global::videotemplate_list = ds_list_create();
		ds_list_add({ global::videotemplate_list, new_videotemplate(/*"avatar"*/ STR(591), IntType(512), IntType(512)), new_videotemplate(/*"hd_720p"*/ STR(592), IntType(1280), IntType(720)), new_videotemplate(/*"fhd_1080p"*/ STR(593), IntType(1920), IntType(1080)), new_videotemplate(/*"qhd_1440p"*/ STR(594), IntType(2560), IntType(1440)), new_videotemplate(/*"uhd_4k"*/ STR(595), IntType(3840), IntType(2160)), new_videotemplate(/*"hd_720p_cinematic"*/ STR(596), IntType(1680), IntType(720)), new_videotemplate(/*"fhd_1080p_cinematic"*/ STR(597), IntType(2560), IntType(1080)), new_videotemplate(/*"qhd_1440p_cinematic"*/ STR(598), IntType(3440), IntType(1440)), new_videotemplate(/*"uhd_4k_cinematic"*/ STR(599), IntType(5120), IntType(2160)) });
		global::videoquality_list = ds_list_create();
		ds_list_add({ global::videoquality_list, new_videoquality(/*"best"*/ STR(600), IntType(5000000)), new_videoquality(/*"high"*/ STR(601), IntType(2500000)), new_videoquality(/*"medium"*/ STR(602), IntType(1200000)), new_videoquality(/*"low"*/ STR(603), IntType(700000)), new_videoquality(/*"verylow"*/ STR(604), IntType(350000)) });
		...
		ds_list_add({ global::biome_list, new_biome(/*"custom"*/ STR(605), IntType(0), IntType(0), true, c_plains_biome_grass, c_plains_biome_foliage, c_plains_biome_water, null_) });
		...
		ds_list_add({ global::blend_mode_list, /*"normal"*/ STR(606), /*"add"*/ STR(607), /*"subtract"*/ STR(608), /*"multiply"*/ STR(609), /*"screen"*/ STR(610) });
		global::blend_mode_map = ds_map_create();
		ds_map_add(global::blend_mode_map, /*"normal"*/ STR(606), bm_normal);
		ds_map_add(global::blend_mode_map, /*"add"*/ STR(607), bm_add);
		ds_map_add(global::blend_mode_map, /*"subtract"*/ STR(608), bm_subtract);
		ds_map_add(global::blend_mode_map, /*"multiply"*/ STR(609), ArrType::From({ bm_zero, bm_src_color }));
		ds_map_add(global::blend_mode_map, /*"screen"*/ STR(610), ArrType::From({ bm_one, bm_inv_src_color }));
		...
		ds_list_add({ global::render_pass_list, /*"combined"*/ STR(611), /*"diffuse"*/ STR(612), /*"specular"*/ STR(613), /*"ao"*/ STR(614), /*"shadows"*/ STR(129), /*"indirect"*/ STR(131), /*"indirectshadows"*/ STR(615), /*"reflections"*/ STR(132), /*"depth"*/ STR(616), /*"normal"*/ STR(606), /*"material"*/ STR(617) });
	}
	...
	{
		sStr(recent_display_mode) = /*"grid"*/ STR(618);
	...
	void app_startup_themes(ScopeAny self)
	{
		...
		{
			self->name = /*"light"*/ STR(619);
			self->dark = false;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DB3030"*/ STR(620)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D85B00"*/ STR(621)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D68E02"*/ STR(622)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"34A100"*/ STR(623)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"0D8E41"*/ STR(624)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"048E8E"*/ STR(625)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"2144F1"*/ STR(626)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"982BCB"*/ STR(627)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"E93983"*/ STR(628)));
			self->level_top = hex_to_color(/*"F7FAFC"*/ STR(629));
			self->level_middle = hex_to_color(/*"ECEFF1"*/ STR(630));
			self->level_bottom = hex_to_color(/*"D7DFE2"*/ STR(631));
			self->viewport_top = hex_to_color(/*"F0FFFF"*/ STR(632));
			self->viewport_bottom = hex_to_color(/*"B5E8F2"*/ STR(633));
			self->text_main = hex_to_color(/*"0D1214"*/ STR(634));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"FFFFFF"*/ STR(635));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .15;
			self->red_error = hex_to_color(/*"FF1D0F"*/ STR(636));
			self->yellow_warning = hex_to_color(/*"FFC01E"*/ STR(637));
			self->green_success = hex_to_color(/*"61C159"*/ STR(638));
			self->red = hex_to_color(/*"FF5656"*/ STR(639));
			self->green = hex_to_color(/*"4AB758"*/ STR(640));
			self->blue = hex_to_color(/*"1370FB"*/ STR(641));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(642));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(643));
			self->yellow = hex_to_color(/*"F4CC5D"*/ STR(644));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(645));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"158AF5"*/ STR(646));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64A56B"*/ STR(647));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"D09522"*/ STR(648));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF1D0F"*/ STR(636));
		}
		
		global::theme_dark = (new obj_theme)->id;
		withOne (obj_theme, global::theme_dark, self->id)
		{
			self->name = /*"dark"*/ STR(649);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(650)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFA360"*/ STR(651)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFF065"*/ STR(652)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"8BFF6D"*/ STR(653)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"4EF390"*/ STR(654)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"49EED9"*/ STR(655)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"98BBFF"*/ STR(656)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(657)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(658)));
			self->level_top = hex_to_color(/*"37444A"*/ STR(659));
			self->level_middle = hex_to_color(/*"2B373D"*/ STR(660));
			self->level_bottom = hex_to_color(/*"18242A"*/ STR(661));
			self->viewport_top = hex_to_color(/*"2B373D"*/ STR(660));
			self->viewport_bottom = hex_to_color(/*"839096"*/ STR(662));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(635));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"000000"*/ STR(663));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .25;
			self->red_error = hex_to_color(/*"FF7A72"*/ STR(664));
			self->yellow_warning = hex_to_color(/*"FFEB36"*/ STR(665));
			self->green_success = hex_to_color(/*"64E879"*/ STR(666));
			self->red = hex_to_color(/*"FF5656"*/ STR(639));
			self->green = hex_to_color(/*"23FF88"*/ STR(667));
			self->blue = hex_to_color(/*"1370FB"*/ STR(641));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(642));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(643));
			self->yellow = hex_to_color(/*"FFD969"*/ STR(668));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(645));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"7EC1FF"*/ STR(669));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64E879"*/ STR(666));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"FFEB36"*/ STR(665));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF7A72"*/ STR(664));
		}
		
		global::theme_darker = (new obj_theme)->id;
		withOne (obj_theme, global::theme_darker, self->id)
		{
			self->name = /*"darker"*/ STR(670);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(650)));
			...
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(657)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(658)));
			self->level_top = hex_to_color(/*"1C1C1C"*/ STR(671));
			self->level_middle = hex_to_color(/*"101010"*/ STR(672));
			self->level_bottom = hex_to_color(/*"050505"*/ STR(673));
			self->viewport_top = hex_to_color(/*"484848"*/ STR(674));
			self->viewport_bottom = hex_to_color(/*"2B2B2B"*/ STR(675));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(635));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
	...
	void app_update_animate(ScopeAny self)
	{
		...
		if (bgobject > 0)
		{
			...
			sVar(background_ground_direction) = ObjType(obj_timeline, bgobject)->value.Value(e_value_BG_GROUND_DIRECTION);
			...
			if (sVar(background_biome) == /*"custom"*/ STR(605) || sVar(background_biome_prev) != sVar(background_biome))
			{
		...
		sInt(background_sky_color_final) = merge_color((IntType)(sVar(background_sky_color)), (IntType)(hex_to_color(/*"020204"*/ STR(677))), background_sky_night_alpha());
	...
	void app_update_caption()
	{
		if (global::_app->project_name != /*""*/ STR(0))
			window_set_caption(global::_app->project_name + string_repeat(/*" * "*/ STR(678), global::_app->project_changed) + /*" - Mine-imator"*/ STR(679));
		else
			window_set_caption(/*"Mine-imator"*/ STR(23));
	...
	void app_update_keybinds()
	{
		...
		for (IntType i = IntType(0); i < e_keybind_amount; i++)
		{
			...
			check = keybind_check(obj, /*"keyboard_check"*/ STR(680));
			idBool(obj, released) = false;
			if (idVar(obj, active) > 0)
				idBool(obj, released) = keybind_check(obj, /*"keyboard_check_released"*/ STR(681));
			idBool(obj, pressed) = keybind_check(obj, /*"keyboard_check_pressed"*/ STR(682));
	...
	void app_update_keyboard(ScopeAny self)
	{
		...
		if (sStr(window_state) == /*""*/ STR(0) && (sVar(window_busy) == /*""*/ STR(0) || sStr(settings_menu_name) == /*"colorpicker"*/ STR(683)) && !sBool(textbox_isediting))
		{
			...
			if (!(sReal(timeline_playing) > 0))
			{
				...
				if (ObjType(obj_keybind, global::keybinds.Value(e_keybind_MARKER_LEFT))->active > 0)
					action_tl_left();
				if (ObjType(obj_keybind, global::keybinds.Value(e_keybind_FRAME_PREVIOUS))->pressed)
					action_tl_frame_previous(self);
				if (ObjType(obj_keybind, global::keybinds.Value(e_keybind_FRAME_NEXT))->pressed)
					action_tl_frame_next(self);
			}
