...
namespace CppProject
{
	void block_load_timeline(Scope<obj_block> self, VarType map, VarType typemap)
	{
		...
		if (is_string(DsMap(map).Value(/*"model"*/ STR(515))))
		{
			...
			if (DsMap(typemap).Value(/*"model_state"*/ STR(853)) == e_json_type_STRING)
			{
				self->tl_model_state = string_get_state_vars(DsMap(map).Value(/*"model_state"*/ STR(853)));
				self->tl_has_model_state = true;
			}
			else
				if (DsMap(typemap).Value(/*"model_state"*/ STR(853)) == e_json_type_OBJECT)
				{
					VarType key = ds_map_find_first((IntType)(DsMap(map).Value(/*"model_state"*/ STR(853))));
					while (!is_undefined(key))
					{
						withOne (obj_block_tl_state, (new obj_block_tl_state)->id, self->id)
						{
							self->vars = string_get_state_vars(key);
							self->value = string_get_state_vars(ds_map_find_value((IntType)(DsMap(map).Value(/*"model_state"*/ STR(853))), key));
						...
						key = ds_map_find_next((IntType)(DsMap(map).Value(/*"model_state"*/ STR(853))), key);
					}
		...
		if (is_bool(DsMap(map).Value(/*"model_double"*/ STR(854))))
			self->model_double = DsMap(map).Value(/*"model_double"*/ STR(854));
		self->tl_has_text = false;
		if (is_bool(DsMap(map).Value(/*"has_text"*/ STR(855))))
			self->tl_has_text = DsMap(map).Value(/*"has_text"*/ STR(855));
		if (self->tl_has_text > 0)
			self->tl_text_position = value_get_point3D({ DsMap(map).Value(/*"text_position"*/ STR(856)), point3D(IntType(0), IntType(0), IntType(0)) });
		self->tl_text_scale = DsMap(map).Value(/*"text_scale"*/ STR(857));
		self->tl_pattern_type = /*""*/ STR(0);
		if (is_string(DsMap(map).Value(/*"pattern_type"*/ STR(858))))
			self->tl_pattern_type = DsMap(map).Value(/*"pattern_type"*/ STR(858));
		self->tl_rot_point = point3D(IntType(0), IntType(0), IntType(0));
		self->tl_rot_point_state_amount = IntType(0);
		if (DsMap(typemap).Value(/*"rotation_point"*/ STR(859)) == e_json_type_ARRAY)
			self->tl_rot_point = value_get_point3D({ DsMap(map).Value(/*"rotation_point"*/ STR(859)), point3D(IntType(0), IntType(0), IntType(0)) });
		else
			if (DsMap(typemap).Value(/*"rotation_point"*/ STR(859)) == e_json_type_OBJECT)
			{
				VarType key = ds_map_find_first((IntType)(DsMap(map).Value(/*"rotation_point"*/ STR(859))));
				while (!is_undefined(key))
				{
					withOne (obj_block_tl_state, (new obj_block_tl_state)->id, self->id)
					{
						self->vars = string_get_state_vars(key);
						self->value = value_get_point3D({ ds_map_find_value((IntType)(DsMap(map).Value(/*"rotation_point"*/ STR(859))), key), point3D(IntType(0), IntType(0), IntType(0)) });
						self->state_id = ArrType();
						for (IntType i = IntType(0); i < ObjType(obj_block, self.otherId)->state_id_amount; i++)
							if (state_vars_match_state_id(self->vars, self.otherId, i))
								self->state_id = array_add(VarType::CreateRef(self->state_id), i);
					...
					key = ds_map_find_next((IntType)(DsMap(map).Value(/*"rotation_point"*/ STR(859))), key);
				}
	...
	BoolType block_load_variant_model(ScopeAny self, VarType map, VarType type)
	{
		...
		{
			log({ /*"Missing parameter \"model\""*/ STR(860) });
			return false;
		}
		...
		if (is_bool(DsMap(map).Value(/*"uvlock"*/ STR(861))))
			uvlock = DsMap(map).Value(/*"uvlock"*/ STR(861));
		else
			if (is_string(DsMap(map).Value(/*"uvlock"*/ STR(861))))
				uvlock = (DsMap(map).Value(/*"uvlock"*/ STR(861)) == /*"true"*/ STR(745));
		
		VarType weight = IntType(1);
		if (!is_undefined(DsMap(map).Value(/*"weight"*/ STR(862))))
			weight = DsMap(map).Value(/*"weight"*/ STR(862));
		...
		switch ((IntType)culldir)
		{
			case e_dir_EAST:
			{
				if (!idBool(el, face_edge_xp) || self->block_face_min_depth_xp == null_ || self->block_face_min_depth_xp > ObjType(obj_block_render_model, model)->face_min_depth_xp)
					return false;
				if (self->block_current != null_ && ObjType(obj_block, self->block_current)->type == /*"leaves"*/ STR(863) && self->block_face_min_depth_xp > e_block_depth_DEPTH0)
					return false;
			...
			case e_dir_WEST:
			{
				if (!idBool(el, face_edge_xn) || self->block_face_min_depth_xn == null_ || self->block_face_min_depth_xn > ObjType(obj_block_render_model, model)->face_min_depth_xn)
					return false;
				if (self->block_current != null_ && ObjType(obj_block, self->block_current)->type == /*"leaves"*/ STR(863) && self->block_face_min_depth_xn > e_block_depth_DEPTH0)
					return false;
			...
			case e_dir_SOUTH:
			{
				if (!idBool(el, face_edge_yp) || self->block_face_min_depth_yp == null_ || self->block_face_min_depth_yp > ObjType(obj_block_render_model, model)->face_min_depth_yp)
					return false;
				if (self->block_current != null_ && ObjType(obj_block, self->block_current)->type == /*"leaves"*/ STR(863) && self->block_face_min_depth_yp > e_block_depth_DEPTH0)
					return false;
			...
			case e_dir_NORTH:
			{
				if (!idBool(el, face_edge_yn) || self->block_face_min_depth_yn == null_ || self->block_face_min_depth_yn > ObjType(obj_block_render_model, model)->face_min_depth_yn)
					return false;
				if (self->block_current != null_ && ObjType(obj_block, self->block_current)->type == /*"leaves"*/ STR(863) && self->block_face_min_depth_yn > e_block_depth_DEPTH0)
					return false;
			...
			case e_dir_UP:
			{
				if (!idBool(el, face_edge_zp) || self->block_face_min_depth_zp == null_ || self->block_face_min_depth_zp > ObjType(obj_block_render_model, model)->face_min_depth_zp)
					return false;
				if (self->block_current != null_ && ObjType(obj_block, self->block_current)->type == /*"leaves"*/ STR(863) && self->block_face_min_depth_zp > e_block_depth_DEPTH0)
					return false;
			...
			case e_dir_DOWN:
			{
				if (!idBool(el, face_edge_zn) || self->block_face_min_depth_zn == null_ || self->block_face_min_depth_zn > ObjType(obj_block_render_model, model)->face_min_depth_zn)
					return false;
				if (self->block_current != null_ && ObjType(obj_block, self->block_current)->type == /*"leaves"*/ STR(863) && self->block_face_min_depth_zn > e_block_depth_DEPTH0)
					return false;
	...
	RealType block_set_bars(ScopeAny self)
	{
		...
		if (!sBool(build_edge_xp))
		{
			...
			if ((block != null_ && (idVar(block, type) == /*"bars"*/ STR(864) || idVar(block, type) == /*"colored_bars"*/ STR(865))) || (sInt(block_face_min_depth_xp) != e_block_depth_DEPTH1 && sBool(block_face_full_xp)))
				east = /*"true"*/ STR(745);
		}
		if (!sBool(build_edge_xn))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x) - IntType(1), sInt(build_pos_y), sInt(build_pos_z));
			if ((block != null_ && (idVar(block, type) == /*"bars"*/ STR(864) || idVar(block, type) == /*"colored_bars"*/ STR(865))) || (sInt(block_face_min_depth_xn) != e_block_depth_DEPTH1 && sBool(block_face_full_xn)))
				west = /*"true"*/ STR(745);
		}
		if (!sBool(build_edge_yp))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z));
			if ((block != null_ && (idVar(block, type) == /*"bars"*/ STR(864) || idVar(block, type) == /*"colored_bars"*/ STR(865))) || (sInt(block_face_min_depth_yp) != e_block_depth_DEPTH1 && sBool(block_face_full_yp)))
				south = /*"true"*/ STR(745);
		}
		if (!sBool(build_edge_yn))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) - IntType(1), sInt(build_pos_z));
			if ((block != null_ && (idVar(block, type) == /*"bars"*/ STR(864) || idVar(block, type) == /*"colored_bars"*/ STR(865))) || (sInt(block_face_min_depth_yn) != e_block_depth_DEPTH1 && sBool(block_face_full_yn)))
				north = /*"true"*/ STR(745);
		}
		sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"east"*/ STR(866), east, /*"west"*/ STR(867), west, /*"south"*/ STR(868), south, /*"north"*/ STR(869), north }));
		return IntType(0);
	}
	
	VarType block_set_bed(Scope<obj_builder_thread> self)
	{
		if (block_get_state_id_value(self->block_current, self->block_state_id_current, /*"part"*/ STR(870)) == /*"head"*/ STR(871))
			return null_;
		return IntType(0);
	}
	...
	{
		if ((self->builder_scenery && !self->builder_scenery_legacy) || block_get_state_id_value(self->block_current, self->block_state_id_current, /*"type"*/ STR(773)) == /*"big_dripleaf_stem"*/ STR(872))
			return IntType(0);
		if (self->build_pos_z != (self->build_size_z - IntType(1)))
		{
			VarType facing = block_get_state_id_value(self->block_current, self->block_state_id_current, /*"facing"*/ STR(873));
			self->block_state_id_current = block_get_state_id(self->block_current, ArrType::From({ /*"type"*/ STR(773), /*"big_dripleaf_stem"*/ STR(872), /*"facing"*/ STR(873), facing, /*"tilt"*/ STR(874), /*"none"*/ STR(875) }));
		}
		return IntType(0);
	}
	...
	RealType block_set_cave_vines(ScopeAny self)
	{
		if (!sBool(build_edge_zp))
		{
			...
			if (block == null_ || idVar(block, type) != /*"cave_vines"*/ STR(876))
				global::vertex_wave_zmax = sInt(block_pos_z) + block_size_;
		}
		else
			global::vertex_wave_zmax = sInt(block_pos_z) + block_size_;
		
		if ((sBool(builder_scenery) && !sBool(builder_scenery_legacy)) || block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"type"*/ STR(773)) == /*"cave_vines_plant"*/ STR(877))
			return IntType(0);
		VarType berries = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"berries"*/ STR(878));
		if (sInt(build_pos_z) == IntType(0))
			sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"type"*/ STR(773), /*"cave_vines"*/ STR(876), /*"berries"*/ STR(878), berries }));
		else
			sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"type"*/ STR(773), /*"cave_vines_plant"*/ STR(877), /*"berries"*/ STR(878), berries }));
	...
	VarType block_set_chest(ScopeAny self)
	{
		...
		switch (StringType(type).id)
		{
			...
			case 880: // legacy
			{
				if (idVar(sInt(block_current), name) == /*"ender_chest"*/ STR(881))
					break;
				IntType connectblock, discardblock;
				connectblock = null_;
				discardblock = null_;
				VarType facing = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"facing"*/ STR(873));
		...
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"double"*/ STR(882), double_);
		return IntType(0);
	}
	...
	RealType block_set_chorus_plant(ScopeAny self)
	{
		...
		{
			IntType block = builder_get_block(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z));
			if (block != null_ && (block == sInt(block_current) || idVar(block, type) == /*"chorus_plant_connect"*/ STR(883)))
				east = /*"true"*/ STR(745);
		}
		if (!sBool(build_edge_xn))
		{
		...
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y), sInt(build_pos_z) - IntType(1));
			if (block != null_ && (block == sInt(block_current) || idVar(block, type) == /*"chorus_plant_connect"*/ STR(883) || idVar(block, name) == /*"end_stone"*/ STR(884)))
				down = /*"true"*/ STR(745);
		}
		sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"east"*/ STR(866), east, /*"west"*/ STR(867), west, /*"south"*/ STR(868), south, /*"north"*/ STR(869), north, /*"up"*/ STR(885), up, /*"down"*/ STR(886), down }));
		return IntType(0);
	}
	...
	RealType block_set_colored_bars(ScopeAny self)
	{
		...
		if (!sBool(builder_scenery) && sInt(build_size_x) == IntType(1) && sInt(build_size_y) == IntType(1))
			return IntType(0);
		VarType color = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"color"*/ STR(887));
		block_set_bars(self);
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"color"*/ STR(887), color);
		return IntType(0);
	}
	
	VarType block_set_door(ScopeAny self)
	{
		if (block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"half"*/ STR(888)) == /*"upper"*/ STR(889))
			return null_;
		VarType hinge = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"hinge"*/ STR(890));
		if (!sBool(build_edge_zp))
		{
			...
			if (aboveblock == sInt(block_current))
			{
				...
				hinge = block_get_state_id_value(sInt(block_current), abovestateid, /*"hinge"*/ STR(890));
				sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"hinge"*/ STR(890), hinge);
			}
		}
		VarType facing, open, dir;
		StringType location;
		facing = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"facing"*/ STR(873));
		open = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"open"*/ STR(891));
		if (facing == /*"east"*/ STR(866))
		{
			location = (hinge == /*"right"*/ STR(189) ? /*"south_west"*/ STR(892) : /*"north_west"*/ STR(893));
			if (open == /*"false"*/ STR(746))
				dir = (hinge == /*"right"*/ STR(189) ? /*"north"*/ STR(869) : /*"south"*/ STR(868));
		}
		else
			if (facing == /*"west"*/ STR(867))
			{
				location = (hinge == /*"right"*/ STR(189) ? /*"north_east"*/ STR(894) : /*"south_east"*/ STR(895));
				if (open == /*"false"*/ STR(746))
					dir = (hinge == /*"right"*/ STR(189) ? /*"south"*/ STR(868) : /*"north"*/ STR(869));
			}
			else
				if (facing == /*"south"*/ STR(868))
				{
					location = (hinge == /*"right"*/ STR(189) ? /*"north_west"*/ STR(893) : /*"north_east"*/ STR(894));
					if (open == /*"false"*/ STR(746))
						dir = (hinge == /*"right"*/ STR(189) ? /*"east"*/ STR(866) : /*"west"*/ STR(867));
				}
				else
					if (facing == /*"north"*/ STR(869))
					{
						location = (hinge == /*"right"*/ STR(189) ? /*"south_east"*/ STR(895) : /*"south_west"*/ STR(892));
						if (open == /*"false"*/ STR(746))
							dir = (hinge == /*"right"*/ STR(189) ? /*"west"*/ STR(867) : /*"east"*/ STR(866));
					}
		...
		VarType topmodel = idVar(sInt(block_current), state_id_model_obj).Value(block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"half"*/ STR(888), /*"upper"*/ STR(889)));
		...
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"location"*/ STR(896), location);
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"direction"*/ STR(897), dir);
	...
	RealType block_set_dripstone(Scope<obj_builder_thread> self)
	{
		...
		thicknessprev = block_get_state_id_value(self->block_current, self->block_state_id_current, /*"thickness"*/ STR(898));
		if (thicknessprev == /*"base"*/ STR(899))
			return IntType(0);
		dir = block_get_state_id_value(self->block_current, self->block_state_id_current, /*"vertical_direction"*/ STR(900));
		size = (dir == /*"up"*/ STR(885) ? (self->build_size_z - IntType(1)) - self->build_pos_z : self->build_pos_z);
		sizeoffset = size;
		if (thicknessprev == /*"frustum"*/ STR(901))
			sizeoffset += IntType(1);
		else
			if (thicknessprev == /*"middle"*/ STR(902))
		...
		if (sizeoffset == IntType(0))
			...
			if (sizeoffset == IntType(1))
				thickness = /*"frustum"*/ STR(901);
			else
				if (size >= (self->build_size_z - IntType(1)))
					thickness = /*"base"*/ STR(899);
				else
					thickness = /*"middle"*/ STR(902);
			
		
		
		self->block_state_id_current = block_get_state_id(self->block_current, ArrType::From({ /*"vertical_direction"*/ STR(900), dir, /*"thickness"*/ STR(898), thickness }));
		return IntType(0);
	}
	...
	RealType block_set_fence(ScopeAny self)
	{
		...
		if (!sBool(build_edge_xp))
		{
			...
			if (block != null_)
			{
				if (idVar(block, type) == idVar(sInt(block_current), type) || (sInt(block_face_min_depth_xp) == e_block_depth_DEPTH0 && sBool(block_face_full_xp)))
					...
					if (idVar(block, type) == /*"fence_gate"*/ STR(903))
					{
						VarType facing = block_get_state_id_value(block, builder_get_state_id(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z)), /*"facing"*/ STR(873));
						if (facing != /*"east"*/ STR(866) && facing != /*"west"*/ STR(867))
							east = /*"true"*/ STR(745);
					}
		...
		if (!sBool(build_edge_yp))
		{
			...
			if (block != null_)
			{
				if (idVar(block, type) == idVar(sInt(block_current), type) || (sInt(block_face_min_depth_yp) == e_block_depth_DEPTH0 && sBool(block_face_full_yp)))
					...
					if (idVar(block, type) == /*"fence_gate"*/ STR(903))
					{
						VarType facing = block_get_state_id_value(block, builder_get_state_id(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z)), /*"facing"*/ STR(873));
						if (facing != /*"south"*/ STR(868) && facing != /*"north"*/ STR(869))
							south = /*"true"*/ STR(745);
					}
		...
		sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"variant"*/ STR(783), variant, /*"east"*/ STR(866), east, /*"west"*/ STR(867), west, /*"south"*/ STR(868), south, /*"north"*/ STR(869), north }));
		return IntType(0);
	}
	...
	RealType block_set_fence_gate(ScopeAny self)
	{
		...
		if (facing == /*"east"*/ STR(866) || facing == /*"west"*/ STR(867))
		{
			if (!sBool(build_edge_yp))
			{
				...
				if (block != null_ && idVar(block, type) == /*"wall"*/ STR(904))
					inwall = /*"true"*/ STR(745);
			}
		...
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"in_wall"*/ STR(905), inwall);
		return IntType(0);
	}
	...
	RealType block_set_fire(ScopeAny self)
	{
		...
		sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"variant"*/ STR(783), variant, /*"east"*/ STR(866), east, /*"west"*/ STR(867), west, /*"south"*/ STR(868), south, /*"north"*/ STR(869), north, /*"up"*/ STR(885), up }));
		return IntType(0);
	}
	...
	RealType block_set_kelp(ScopeAny self)
	{
		...
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y), sInt(build_pos_z) - IntType(1));
			if (block == null_ || idVar(block, type) != /*"kelp"*/ STR(906))
				global::vertex_wave_zmin = sInt(block_pos_z);
		}
		else
			global::vertex_wave_zmin = sInt(block_pos_z);
		
		if ((sBool(builder_scenery) && !sBool(builder_scenery_legacy)) || block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"variant"*/ STR(783)) == /*"kelp_plant"*/ STR(907))
			return IntType(0);
		if (sInt(build_pos_z) != (sInt(build_size_z) - IntType(1)))
			sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"variant"*/ STR(783), /*"kelp_plant"*/ STR(907) }));
		return IntType(0);
	}
	...
	RealType block_set_redstone_repeater(ScopeAny self)
	{
		if (sBool(builder_scenery) && !sBool(builder_scenery_legacy))
			return IntType(0);
		if (block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"locked"*/ STR(908)) == /*"true"*/ STR(745))
			return IntType(0);
		VarType facing;
		StringType locked;
		facing = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"facing"*/ STR(873));
		locked = /*"false"*/ STR(746);
		if (!sBool(build_edge_xp) && (facing == /*"south"*/ STR(868) || facing == /*"north"*/ STR(869)))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z));
			if (block != null_ && idVar(block, name) == /*"powered_repeater"*/ STR(909))
			{
				IntType stateid = builder_get_state_id(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z));
				if (block_get_state_id_value(block, stateid, /*"facing"*/ STR(873)) == /*"east"*/ STR(866))
					locked = /*"true"*/ STR(745);
			}
		}
		if (locked == /*"false"*/ STR(746) && !sBool(build_edge_xn) && (facing == /*"south"*/ STR(868) || facing == /*"north"*/ STR(869)))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x) - IntType(1), sInt(build_pos_y), sInt(build_pos_z));
			if (block != null_ && idVar(block, name) == /*"powered_repeater"*/ STR(909))
			{
				IntType stateid = builder_get_state_id(self, sInt(build_pos_x) - IntType(1), sInt(build_pos_y), sInt(build_pos_z));
				if (block_get_state_id_value(block, stateid, /*"facing"*/ STR(873)) == /*"west"*/ STR(867))
					locked = /*"true"*/ STR(745);
			}
		}
		if (locked == /*"false"*/ STR(746) && !sBool(build_edge_yp) && (facing == /*"east"*/ STR(866) || facing == /*"west"*/ STR(867)))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z));
			if (block != null_ && idVar(block, name) == /*"powered_repeater"*/ STR(909))
			{
				IntType stateid = builder_get_state_id(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z));
				if (block_get_state_id_value(block, stateid, /*"facing"*/ STR(873)) == /*"south"*/ STR(868))
					locked = /*"true"*/ STR(745);
			}
		}
		if (locked == /*"false"*/ STR(746) && !sBool(build_edge_yn) && (facing == /*"east"*/ STR(866) || facing == /*"west"*/ STR(867)))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) - IntType(1), sInt(build_pos_z));
			if (block != null_ && idVar(block, name) == /*"powered_repeater"*/ STR(909))
			{
				IntType stateid = builder_get_state_id(self, sInt(build_pos_x), sInt(build_pos_y) - IntType(1), sInt(build_pos_z));
				if (block_get_state_id_value(block, stateid, /*"facing"*/ STR(873)) == /*"north"*/ STR(869))
					locked = /*"true"*/ STR(745);
			}
		}
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"locked"*/ STR(908), locked);
		return IntType(0);
	}
	...
	RealType block_set_redstone_wire(ScopeAny self)
	{
		...
		pow = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"power"*/ STR(910));
		...
		if (!sBool(build_edge_xp))
		{
			...
			if (block != null_)
			{
				if (block == sInt(block_current) || idVar(block, type) == /*"redstone_connect"*/ STR(911))
					east = /*"side"*/ STR(912);
				else
					if (idVar(block, type) == /*"redstone_repeater"*/ STR(913) || idVar(block, type) == /*"redstone_comparator"*/ STR(914))
					{
						VarType facing = block_get_state_id_value(block, builder_get_state_id(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z)), /*"facing"*/ STR(873));
						if (facing == /*"east"*/ STR(866) || facing == /*"west"*/ STR(867))
							east = /*"side"*/ STR(912);
			...
			if (east == /*"none"*/ STR(875) && !sBool(build_edge_zp) && !(sInt(block_face_min_depth_zp) == e_block_depth_DEPTH0 && sBool(block_face_full_zp)))
			{
			...
			if (east == /*"none"*/ STR(875) && !sBool(build_edge_zn) && !(sInt(block_face_min_depth_xp) == e_block_depth_DEPTH0 && sBool(block_face_full_xp)))
			{
				block = builder_get_block(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z) - IntType(1));
				if (block == sInt(block_current))
					east = /*"side"*/ STR(912);
		...
		if (!sBool(build_edge_xn))
		{
			...
			if (west == /*"none"*/ STR(875) && !sBool(build_edge_zp) && !(sInt(block_face_min_depth_zp) == e_block_depth_DEPTH0 && sBool(block_face_full_zp)))
			{
				block = builder_get_block(self, sInt(build_pos_x) - IntType(1), sInt(build_pos_y), sInt(build_pos_z) + IntType(1));
				if (block == sInt(block_current))
					west = /*"up"*/ STR(885);
			}
			if (west == /*"none"*/ STR(875) && !sBool(build_edge_zn) && !(sInt(block_face_min_depth_xn) == e_block_depth_DEPTH0 && sBool(block_face_full_xn)))
			{
				block = builder_get_block(self, sInt(build_pos_x) - IntType(1), sInt(build_pos_y), sInt(build_pos_z) - IntType(1));
				if (block == sInt(block_current))
					west = /*"side"*/ STR(912);
		...
		if (!sBool(build_edge_yp))
		{
			...
			if (south == /*"none"*/ STR(875) && !sBool(build_edge_zp) && !(sInt(block_face_min_depth_zp) == e_block_depth_DEPTH0 && sBool(block_face_full_zp)))
			{
				block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z) + IntType(1));
				if (block == sInt(block_current))
					south = /*"up"*/ STR(885);
			}
			if (south == /*"none"*/ STR(875) && !sBool(build_edge_zn) && !(sInt(block_face_min_depth_yp) == e_block_depth_DEPTH0 && sBool(block_face_full_yp)))
			{
				block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z) - IntType(1));
				if (block == sInt(block_current))
					south = /*"side"*/ STR(912);
		...
		if (!sBool(build_edge_yn))
		{
			...
			if (north == /*"none"*/ STR(875) && !sBool(build_edge_zp) && !(sInt(block_face_min_depth_zp) == e_block_depth_DEPTH0 && sBool(block_face_full_zp)))
			{
				block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) - IntType(1), sInt(build_pos_z) + IntType(1));
				if (block == sInt(block_current))
					north = /*"up"*/ STR(885);
			}
			if (north == /*"none"*/ STR(875) && !sBool(build_edge_zn) && !(sInt(block_face_min_depth_yn) == e_block_depth_DEPTH0 && sBool(block_face_full_yn)))
			{
				block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) - IntType(1), sInt(build_pos_z) - IntType(1));
				if (block == sInt(block_current))
					north = /*"side"*/ STR(912);
		...
		if (east == /*"none"*/ STR(875) && west == /*"none"*/ STR(875) && south == /*"none"*/ STR(875) && north == /*"none"*/ STR(875))
		{
			east = /*"side"*/ STR(912);
			west = /*"side"*/ STR(912);
			south = /*"side"*/ STR(912);
		...
		sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"east"*/ STR(866), east, /*"west"*/ STR(867), west, /*"south"*/ STR(868), south, /*"north"*/ STR(869), north, /*"power"*/ STR(910), pow }));
		return IntType(0);
	}
