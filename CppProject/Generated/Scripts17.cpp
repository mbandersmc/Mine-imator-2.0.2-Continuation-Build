...
namespace CppProject
{
	...
	void app_startup_interface_popups()
	{
		...
		global::_app->popup_importitemsheet = new_popup({ /*"importitemsheet"*/ STR(206), ID_popup_importitemsheet_draw, IntType(280), null_, true });
	...
	void app_startup_interface_tabs()
	{
		...
		withOne (obj_tab, global::_app->properties, global::_app->id)
		{
			...
			withOne (obj_category, self->background, self->id)
			{
				...
				self->tbx_ground_direction = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_ground_direction)->suffix = /*"°"*/ STR(220);
