...
namespace CppProject
{
	...
	{
		sArr(value_type_show)[e_value_type_TRANSFORM] = ObjType(obj_category, ObjType(obj_tab, global::_app->frame_editor)->transform)->show;
		sArr(value_type_show)[e_value_type_CAMERA] = idReal(ObjType(obj_tab, global::_app->frame_editor)->camera, show);
	}
	...
	VarType tl_value_find_save_id(VarType vid, VarType oldval, VarType newval)
	{
		...
		if (tl_value_is_texture(vid) && newval == /*"none"*/ STR(876))
			newval = IntType(0);
		else
