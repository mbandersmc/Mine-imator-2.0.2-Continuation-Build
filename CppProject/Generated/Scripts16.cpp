/*
	...
	[ Generated on 2024.01.24 14:23:46 ]
*/
...
namespace CppProject
{
	...
	void app_startup_collapse()
	{
		...
		collapse_register(/*"backup"*/ STR(120));
		collapse_register(/*"watermark"*/ STR(33));
		collapse_register(/*"file"*/ STR(121));
		collapse_register(/*"edit"*/ STR(122));
		collapse_register(/*"tools"*/ STR(123));
		collapse_register(/*"viewport"*/ STR(124));
		collapse_register(/*"timeline"*/ STR(125));
		collapse_register(/*"camera"*/ STR(126));
		collapse_register(/*"texfilter"*/ STR(127));
		collapse_register(/*"ssao"*/ STR(128));
		collapse_register(/*"shadows"*/ STR(129));
		collapse_register(/*"subsurface"*/ STR(130));
		collapse_register(/*"indirect"*/ STR(131));
		collapse_register(/*"reflections"*/ STR(132));
		collapse_register(/*"glow"*/ STR(133));
		collapse_register(/*"glow_falloff"*/ STR(134));
		collapse_register(/*"aa"*/ STR(135));
		collapse_register(/*"light_management"*/ STR(136));
		collapse_register(/*"models_scenery"*/ STR(137));
		collapse_register(/*"glint"*/ STR(138));
		collapse_register(/*"sunlight"*/ STR(139));
		collapse_register(/*"sky"*/ STR(140));
		collapse_register(/*"clouds"*/ STR(141));
		collapse_register(/*"ground"*/ STR(142));
		collapse_register(/*"fog"*/ STR(143));
		collapse_register(/*"wind"*/ STR(144));
		collapse_register(/*"follow_path"*/ STR(145));
		collapse_register(/*"rotatepoint"*/ STR(146));
		collapse_register(/*"ik"*/ STR(147));
		collapse_register(/*"path_shape"*/ STR(148));
		collapse_register(/*"path_shape_tube"*/ STR(149));
		collapse_register(/*"light_management_cam"*/ STR(150));
		collapse_register(/*"aperture"*/ STR(151));
		collapse_register(/*"camshake"*/ STR(152));
		collapse_register(/*"dof"*/ STR(153));
		collapse_register(/*"dof_fringe"*/ STR(154));
		collapse_register(/*"bloom"*/ STR(155));
		collapse_register(/*"lensdirt"*/ STR(156));
		collapse_register(/*"clrcor"*/ STR(157));
		collapse_register(/*"grain"*/ STR(158));
		collapse_register(/*"vignette"*/ STR(159));
		collapse_register(/*"ca"*/ STR(160));
		collapse_register(/*"distort"*/ STR(161));
		collapse_register(/*"itemslot"*/ STR(162));
		collapse_register(/*"material_color"*/ STR(163));
		collapse_register(/*"material_surface"*/ STR(164));
		collapse_register(/*"material_subsurface"*/ STR(165));
		collapse_register(/*"textoutline"*/ STR(166));
		collapse_register(/*"tl_glint"*/ STR(167));
	}
	
	void app_startup_fonts(ScopeAny self)
	{
		sInt(font_subheading) = font_add(fonts_directory + /*"rubik_medium.ttf"*/ STR(168), (IntType)(8.5), false, false, IntType(32), IntType(1024));
		sInt(font_label) = font_add(fonts_directory + /*"noto_bold.ttf"*/ STR(169), IntType(9), false, false, IntType(32), IntType(1024));
		sInt(font_value) = font_add(fonts_directory + /*"noto_regular.ttf"*/ STR(170), IntType(9), false, false, IntType(32), IntType(1024));
		sInt(font_digits) = font_add(fonts_directory + /*"notomono_regular.ttf"*/ STR(171), IntType(9), false, false, IntType(32), IntType(1024));
		sInt(font_caption) = font_add(fonts_directory + /*"noto_regular.ttf"*/ STR(170), IntType(8), false, false, IntType(32), IntType(1024));
		sInt(font_button) = font_add(fonts_directory + /*"rubik_medium.ttf"*/ STR(168), (IntType)(9.5), false, false, IntType(32), IntType(1024));
		sVar(font_upgrade) = font_add(fonts_directory + /*"noto_regular.ttf"*/ STR(170), IntType(18), false, false, IntType(32), IntType(1024));
		sInt(font_heading) = font_add(fonts_directory + /*"rubik_medium.ttf"*/ STR(168), IntType(10), false, false, IntType(32), IntType(1024));
		sVar(font_body_big) = font_add(fonts_directory + /*"noto_regular.ttf"*/ STR(170), IntType(12), false, false, IntType(32), IntType(1024));
		sInt(font_heading_big) = font_add(fonts_directory + /*"rubik_medium.ttf"*/ STR(168), IntType(13), false, false, IntType(32), IntType(1024));
	}
	...
	void app_startup_interface(ScopeAny self)
	{
		...
		if (dev_mode)
		{
			...
			if (dev_mode_project != /*""*/ STR(0))
			{
				...
				{
					sStr(setting_project_folder) = filename_dir(filename_dir(dev_mode_project)) + /*"/"*/ STR(20);
			...
			{
				StringType projfile = sStr(setting_project_folder) + ObjType(obj_popup, sInt(popup_newproject))->folder + /*"/New Project.miproject"*/ STR(172);
	...
	void app_startup_interface_bench()
	{
		...
		list_item_add(/*"typechar"*/ STR(173), e_tl_type_CHARACTER, /*""*/ STR(0), null_, icons_CHARACTER, null_, ID_bench_click);
		list_item_add(/*"typebodypart"*/ STR(174), e_tl_type_BODYPART, /*""*/ STR(0), null_, icons_PART, null_, ID_bench_click);
		list_item_add(/*"typemodel"*/ STR(175), e_tl_type_MODEL, /*""*/ STR(0), null_, icons_MODEL, null_, ID_bench_click);
		list_item_add(/*"typeitem"*/ STR(176), e_tl_type_ITEM, /*""*/ STR(0), null_, icons_ITEM, null_, ID_bench_click);
		list_item_add(/*"typescenery"*/ STR(177), e_tl_type_SCENERY, /*""*/ STR(0), null_, icons_SCENERY, null_, ID_bench_click);
		list_item_add(/*"typeblock"*/ STR(178), e_tl_type_BLOCK, /*""*/ STR(0), null_, icons_BLOCK, null_, ID_bench_click);
		list_item_add(/*"typespblock"*/ STR(179), e_tl_type_SPECIAL_BLOCK, /*""*/ STR(0), null_, icons_BLOCK_SPECIAL, null_, ID_bench_click);
		list_item_add(/*"typeshape"*/ STR(180), e_tl_type_SHAPE, /*""*/ STR(0), null_, icons_SHAPES, null_, ID_bench_click);
		list_item_add(/*"typetext"*/ STR(181), e_tl_type_TEXT, /*""*/ STR(0), null_, icons_TEXT, null_, ID_bench_click);
		list_item_add(/*"typepath"*/ STR(182), e_tl_type_PATH, /*""*/ STR(0), null_, icons_PATH, null_, ID_bench_click);
		list_item_add(/*"typecamera"*/ STR(183), e_tl_type_CAMERA, /*""*/ STR(0), null_, icons_CAMERA, null_, ID_bench_click);
		list_item_add(/*"typeparticles"*/ STR(184), e_tl_type_PARTICLE_SPAWNER, /*""*/ STR(0), null_, icons_FIREWORKS, null_, ID_bench_click);
		list_item_add(/*"typelightsource"*/ STR(185), e_tl_type_LIGHT_SOURCE, /*""*/ STR(0), null_, icons_LIGHT_POINT, null_, ID_bench_click);
		list_item_add(/*"typeaudio"*/ STR(186), e_tl_type_AUDIO, /*""*/ STR(0), null_, icons_NOTE, null_, ID_bench_click);
		list_item_add(/*"typebackground"*/ STR(187), e_tl_type_BACKGROUND, /*""*/ STR(0), null_, icons_CLOUD, null_, ID_bench_click);
		...
		withOne (obj_bench_settings, global::_app->bench_settings, global::_app->id)
		{
			...
			sortlist_column_add(self->particles_list, /*"particlepresetname"*/ STR(192), IntType(0));
		}
