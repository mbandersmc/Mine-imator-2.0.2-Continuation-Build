...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3766) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3767) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3768))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3769) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3768))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3768))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3770))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3771))
		{
			sInt(mouse_cursor) = cr_size_ns;
