...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3770) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3771) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3772))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3773) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3772))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3772))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3774))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3775))
		{
			sInt(mouse_cursor) = cr_size_ns;
