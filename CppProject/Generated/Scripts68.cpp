...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3767) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3768) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3769))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3770) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3769))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3769))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3771))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3772))
		{
			sInt(mouse_cursor) = cr_size_ns;
