...
namespace CppProject
{
	RealType project_load(ScopeAny self, VarArgs argument)
	{
		...
		if (argument_count > IntType(0))
			...
			fn = file_dialog_open_project(self);
	...
	RealType project_load_background(ScopeAny self, VarType map)
	{
		...
		sVar(background_fog_custom_object_color) = value_get_real({ DsMap(map).Value(/*"fog_custom_object_color"*/ STR(2107)), sVar(background_fog_custom_object_color) });
