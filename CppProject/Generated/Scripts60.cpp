/*
	...
	[ Generated on 2023.04.17 17:40:59 ]
*/
...
namespace CppProject
{
	RealType tab_template_editor_particles(ScopeAny self)
	{
		...
		if (!(idVar(global::temp_edit, pc_spawn_constant) > 0))
		{
			...
			if (draw_button_icon(self, { /*"particleeditorspawn"*/ STR(3421), setx, sVar(dy), IntType(24), IntType(24), false, icons_PARTICLES, null_, false, /*"tooltipparticlesspawn"*/ STR(2044) }))
				action_lib_pc_spawn();
			setx -= 28.0;
		}
