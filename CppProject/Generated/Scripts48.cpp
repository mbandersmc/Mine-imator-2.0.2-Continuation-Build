...
namespace CppProject
{
	...
	void render_refresh_effects(VarArgs argument)
	{
		IntType argument_count = argument.Size();
		VarType sceneeffects, posteffects;
		sceneeffects = true;
		if (argument_count > IntType(1))
			sceneeffects = argument[IntType(1)];
		posteffects = true;
		if (argument_count > IntType(2))
			posteffects = argument[IntType(2)];
		ds_list_clear(global::render_effects_list);
		ds_list_add({ global::render_effects_list, global::render_camera_dof && sceneeffects > 0, global::render_glow && (sceneeffects > 0 || posteffects > 0), global::render_glow_falloff && (sceneeffects > 0 || posteffects > 0), global::render_camera_bloom && posteffects > 0, global::render_camera_lens_dirt, global::render_camera_ca && posteffects > 0, global::render_camera_distort && posteffects > 0, global::render_camera_color_correction && posteffects > 0, global::render_camera_grain && posteffects > 0, global::render_camera_vignette && posteffects > 0, global::render_overlay && posteffects > 0 });
		global::render_effects_progress = -IntType(1);
	...
	RealType render_set_texture(VarType tex, StringType type)
	{
		...
		sampler = DsMap(idInt(global::render_shader_obj, sampler_map)).Value(/*"uTexture"*/ STR(1875) + type);
		scalex = IntType(1);
		scaley = IntType(1);
