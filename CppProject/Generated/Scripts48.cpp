...
namespace CppProject
{
	...
	VarType render_post(ScopeAny self, VarType finalsurf, BoolType sceneeffects, BoolType posteffects)
	{
		...
		render_update_effects();
		if (global::render_glow && sceneeffects)
			finalsurf = render_high_glow(self, { finalsurf });
		render_update_effects();
		if (global::render_glow_falloff && sceneeffects)
		...
		render_update_effects();
		if (global::render_camera_lens_dirt && posteffects)
	...
	void render_refresh_effects(BoolType sceneeffects, BoolType posteffects)
	{
		...
		ds_list_add({ global::render_effects_list, global::render_camera_dof && sceneeffects, global::render_camera_bloom && sceneeffects, global::render_glow && sceneeffects, global::render_glow_falloff && sceneeffects, global::render_camera_ca && posteffects, global::render_camera_distort && posteffects, global::render_camera_lens_dirt && posteffects, global::render_camera_color_correction && posteffects, global::render_camera_grain && posteffects, global::render_camera_vignette && posteffects, global::render_overlay && posteffects });
		global::render_effects_progress = -IntType(1);
	...
	RealType render_set_texture(VarType tex, StringType type)
	{
		...
		sampler = DsMap(idInt(global::render_shader_obj, sampler_map)).Value(/*"uTexture"*/ STR(1871) + type);
		scalex = IntType(1);
		scaley = IntType(1);
